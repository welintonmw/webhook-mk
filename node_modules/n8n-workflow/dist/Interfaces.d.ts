...
export type IAllExecuteFunctions = IExecuteFunctions | IExecutePaginationFunctions | IExecuteSingleFunctions | IHookFunctions | ILoadOptionsFunctions | IPollFunctions | ITriggerFunctions | IWebhookFunctions;
...
export type ExecutionError = ExpressionError | WorkflowActivationError | WorkflowOperationError | NodeOperationError | NodeApiError;
...
export interface IGetExecuteHookFunctions {
    (workflow: Workflow, node: INode, additionalData: IWorkflowExecuteAdditionalData, mode: WorkflowExecuteMode, activation: WorkflowActivateMode, webhookData?: IWebhookData): IHookFunctions;
}
...
export type IExecuteFunctions = ExecuteFunctions.GetNodeParameterFn & BaseExecutionFunctions & {
    executeWorkflow(workflowInfo: IExecuteWorkflowInfo, inputData?: INodeExecutionData[], parentCallbackManager?: CallbackManager): Promise<any>;
    ...
    addInputData(connectionType: ConnectionTypes, data: INodeExecutionData[][] | ExecutionError, runIndex?: number): {
        index: number;
    };
    addOutputData(connectionType: ConnectionTypes, currentNodeRunIndex: number, data: INodeExecutionData[][] | ExecutionError): void;
...
export type NodePropertyTypes = 'boolean' | 'button' | 'collection' | 'color' | 'dateTime' | 'fixedCollection' | 'hidden' | 'json' | 'notice' | 'multiOptions' | 'number' | 'options' | 'string' | 'credentialsSelect' | 'resourceLocator' | 'curlImport' | 'resourceMapper' | 'filter' | 'assignmentCollection' | 'credentials';
...
export declare class NodeExecutionOutput extends Array {
    private hints;
...
export type NodeIconColor = 'gray' | 'black' | 'blue' | 'light-blue' | 'dark-blue' | 'orange' | 'orange-red' | 'pink-red' | 'red' | 'light-green' | 'green' | 'dark-green' | 'azure' | 'purple' | 'crimson';
...
export type ConnectionTypes = 'ai_agent' | 'ai_chain' | 'ai_document' | 'ai_embedding' | 'ai_languageModel' | 'ai_memory' | 'ai_outputParser' | 'ai_retriever' | 'ai_textSplitter' | 'ai_tool' | 'ai_vectorRetriever' | 'ai_vectorStore' | 'main';
...
export declare const eventNamesAiNodes: readonly ["n8n.ai.memory.get.messages", "n8n.ai.memory.added.message", "n8n.ai.output.parser.get.instructions", "n8n.ai.output.parser.parsed", "n8n.ai.retriever.get.relevant.documents", "n8n.ai.embeddings.embedded.document", "n8n.ai.embeddings.embedded.query", "n8n.ai.document.processed", "n8n.ai.text.splitter.split", "n8n.ai.tool.called", "n8n.ai.vector.store.searched", "n8n.ai.llm.generated", "n8n.ai.llm.error", "n8n.ai.vector.store.populated"];
...
export interface IWorkflowExecuteAdditionalData {
    ...
    executeWorkflow: (workflowInfo: IExecuteWorkflowInfo, additionalData: IWorkflowExecuteAdditionalData, options: ExecuteWorkflowOptions) => Promise<any>;
    executionId?: string;
    ...
    logAiEvent: (eventName: EventNamesAiNodesType, payload: {
        msg?: string;
        executionId: string;
        nodeName: string;
        workflowId?: string;
...
export type BannerName = 'V1' | 'TRIAL_OVER' | 'TRIAL' | 'NON_PRODUCTION_LICENSE' | 'EMAIL_CONFIRMATION';
