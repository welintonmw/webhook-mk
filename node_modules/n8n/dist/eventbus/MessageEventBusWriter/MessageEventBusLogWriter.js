    ...
    static async getInstance(options) {
        ...
        if (!MessageEventBusLogWriter.instance) {
            ...
            MessageEventBusLogWriter.options = {
                logFullBasePath: path_1.default.join((_a = options === null || options === void 0 ? void 0 : options.logBasePath) !== null && _a !== void 0 ? _a : typedi_1.default.get(n8n_core_1.InstanceSettings).n8nFolder, (_b = options === null || options === void 0 ? void 0 : options.logBaseName) !== null && _b !== void 0 ? _b : config_1.default.getEnv('eventBus.logWriter.logBaseName')),
