...
convict_1.default.addFormat({
    ...
    coerce: (rawStr) => (0, n8n_workflow_1.jsonParse)(rawStr, {
...
exports.schema = {
    ...
    workflows: {
        ...
        callerPolicyDefaultOption: {
            ...
            format: ['any', 'none', 'workflowsFromAList', 'workflowsFromSameOwner'],
    ...
    generic: {
        ...
        instanceType: {
            ...
            format: ['main', 'webhook', 'worker'],
            default: 'main',
        },
        releaseChannel: {
            doc: 'N8N release channel',
            format: ['stable', 'beta', 'nightly', 'dev'],
            default: 'stable',
    ...
    logs: {
        level: {
            ...
            format: n8n_workflow_1.LOG_LEVELS,
            default: 'info',
            env: 'N8N_LOG_LEVEL',
        },
        output: {
        ...
        file: {
            ...
            location: {
                ...
                format: String,
                default: path_1.default.join(typedi_1.Container.get(n8n_core_1.InstanceSettings).n8nFolder, 'logs/n8n.log'),
