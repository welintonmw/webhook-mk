...
class AddAPIKeyColumn1652905585850 {
    ...
    async up({ queryRunner, tablePrefix }) {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_${tablePrefix}ie0zomxves9w3p774drfrkxtj5" ON "${tablePrefix}user" ("apiKey")`);
    }
