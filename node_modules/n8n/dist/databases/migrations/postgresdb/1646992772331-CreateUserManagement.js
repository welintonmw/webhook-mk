...
class CreateUserManagement1646992772331 {
    async up({ queryRunner, tablePrefix, loadSurveyFromDisk }) {
        ...
        await queryRunner.query(`INSERT INTO "${tablePrefix}user" ("id", "globalRoleId", "personalizationAnswers") values ($1, $2, $3)`, [ownerUserId, instanceOwnerRole[0].insertId, survey]);
        ...
        await queryRunner.query(`INSERT INTO ${tablePrefix}settings ("key", "value", "loadOnStartup") VALUES ('userManagement.isInstanceOwnerSetUp', 'false', true), ('userManagement.skipInstanceOwnerSetup', 'false', true)`);
        await queryRunner.query(`INSERT INTO ${tablePrefix}settings ("key", "value", "loadOnStartup") VALUES ($1, $2, $3)`, ['ui.banners.dismissed', '["V1"]', true]);
    }
