...
exports.generateCurlCommandFallbackPromptTemplate = exports.generateCurlCommandPromptTemplate = void 0;
const prompts_1 = require("@langchain/core/prompts");
exports.generateCurlCommandPromptTemplate = new prompts_1.ChatPromptTemplate({
    promptMessages: [
        prompts_1.SystemMessagePromptTemplate.fromTemplate(`# What you need to do
...
IMPORTANT: Only construct a curl command for the specific endpoint and method that matches what the user described. Ensure that the command is valid and respects the steps above. If you fail to provide a valid curl command, your response will be rejected.`),
        prompts_1.HumanMessagePromptTemplate.fromTemplate(`Service name: {serviceName}
Service request: {serviceRequest}`),
    ],
    inputVariables: ['endpoints', 'serviceName', 'serviceRequest'],
});
exports.generateCurlCommandFallbackPromptTemplate = new prompts_1.ChatPromptTemplate({
    promptMessages: [
        prompts_1.SystemMessagePromptTemplate.fromTemplate(`# What you need to do
