...
export declare class ChatGroq extends BaseChatModel<ChatGroqCallOptions, AIMessageChunk> {
    ...
    bindTools(tools: (Record<string, unknown> | StructuredToolInterface)[], kwargs?: Partial<ChatGroqCallOptions>): Runnable<BaseLanguageModelInput, AIMessageChunk, ChatGroqCallOptions>;
