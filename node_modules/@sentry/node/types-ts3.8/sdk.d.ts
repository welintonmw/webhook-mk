...
export declare const defaultIntegrations: (Console | Http | OnUncaughtException | OnUnhandledRejection | Modules | ContextLines | Context | LocalVariables | Undici | CoreIntegrations.InboundFilters | CoreIntegrations.FunctionToString | CoreIntegrations.LinkedErrors | RequestData)[];
/**
