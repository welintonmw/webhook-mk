 ...
 */
const gapicConfig = require("./file_service_client_config.json");
...
class FileServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1beta.FileService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.fileServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ai.generativelanguage.v1beta.FileService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ai.generativelanguage.v1beta.FileService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of fileServiceStubMethods) {
            const callPromise = this.fileServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createFile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
//# sourceMappingURL=file_service_client.js.map