...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createTunedModelResponse = protoFilesRoot.lookup('.google.ai.generativelanguage.v1beta.TunedModel');
        const createTunedModelMetadata = protoFilesRoot.lookup('.google.ai.generativelanguage.v1beta.CreateTunedModelMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1beta.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ai.generativelanguage.v1beta.ModelService')
    ...
    updateTunedModel(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tuned_model.name': (_a = request.tunedModel.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
