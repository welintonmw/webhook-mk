...
class Aws {
    ...
    async authenticate(rawCredentials, requestOptions) {
        ...
        let path = (_c = (_b = requestOptions.qs) === null || _b === void 0 ? void 0 : _b.path) !== null && _c !== void 0 ? _c : '';
        const method = requestOptions.method;
        let body = requestOptions.body;
        let region = credentials.region;
        if ((_d = requestOptions.qs) === null || _d === void 0 ? void 0 : _d._region) {
            region = requestOptions.qs._region;
            delete requestOptions.qs._region;
        }
        let query = (_e = requestOptions.qs) === null || _e === void 0 ? void 0 : _e.query;
        ...
        if (requestWithUri.uri) {
            ...
            if (service === 'sts') {
                try {
                    if (((_f = requestWithUri.qs) === null || _f === void 0 ? void 0 : _f.Action) !== 'GetCallerIdentity') {
        ...
        const signOpts = {
            ...requestOptions,
            headers: (_g = requestOptions.headers) !== null && _g !== void 0 ? _g : {},
            host: endpoint.host,
            method,
            path,
