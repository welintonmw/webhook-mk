            ...
            try {
                if (resource === 'bucket') {
                    ...
                    if (operation === 'search') {
                        ...
                        qs['list-type'] = 2;
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'download') {
                        ...
                        let region = await GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                    ...
                    if (operation === 'upload') {
                        ...
                        if (isBinaryData) {
                            ...
                            responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'PUT', `${path}${fileName || binaryData.fileName}`, body, qs, headers, {}, region);
                        }
                        else {
