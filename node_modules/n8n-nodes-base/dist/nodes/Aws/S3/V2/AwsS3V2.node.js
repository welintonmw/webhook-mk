                    ...
                    if (operation === 'upload') {
                        ...
                        if (isBinaryData) {
                            ...
                            if (binaryPropertyData.id) {
                                ...
                                const createMultiPartUpload = await GenericFunctions_1.awsApiRequestREST.call(this, servicePath, 'POST', `${path}?uploads`, body, qs, { ...neededHeaders, ...multipartHeaders }, {}, region);
