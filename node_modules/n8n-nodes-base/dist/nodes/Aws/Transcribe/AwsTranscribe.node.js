            ...
            try {
                if (resource === 'transcriptionJob') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestREST.call(this, 'transcribe', 'POST', '', JSON.stringify(body), { 'x-amz-target': action, 'Content-Type': 'application/x-amz-json-1.1' });
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll === true) {
                            responseData = await GenericFunctions_1.awsApiRequestRESTAllItems.call(this, 'TranscriptionJobSummaries', 'transcribe', 'POST', '', JSON.stringify(body), { 'x-amz-target': action, 'Content-Type': 'application/x-amz-json-1.1' });
                        }
                        else {
...
//# sourceMappingURL=AwsTranscribe.node.js.map