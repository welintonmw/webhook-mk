    ...
    constructor() {
        ...
        this.methods = {
            loadOptions: {
                async getTemplates() {
                    const returnData = [];
                    const templates = await GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListTemplatesResponse.ListTemplatesResult.TemplatesMetadata.member', 'email', 'POST', '/?Action=ListTemplates');
            ...
            try {
                if (resource === 'customVerificationEmail') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '', node_querystring_1.default.stringify({
                    ...
                    if (operation === 'delete') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '', params.join('&'));
                        responseData = responseData.DeleteCustomVerificationEmailTemplateResponse;
                    }
                    if (operation === 'get') {
                        const templateName = this.getNodeParameter('templateName', i);
                        const params = [`TemplateName=${templateName}`];
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=GetCustomVerificationEmailTemplate&' + params.join('&'));
                        responseData = responseData.GetCustomVerificationEmailTemplateResponse;
                    }
                    if (operation === 'getAll') {
                        const returnAll = this.getNodeParameter('returnAll', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListCustomVerificationEmailTemplatesResponse.ListCustomVerificationEmailTemplatesResult.CustomVerificationEmailTemplates.member', 'email', 'POST', '/?Action=ListCustomVerificationEmailTemplates');
                        }
                        else {
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'GET', `/?Action=ListCustomVerificationEmailTemplates&MaxResults=${limit}`);
                            responseData =
                ...
                if (resource === 'email') {
                    if (operation === 'send') {
                        ...
                        if (toAddresses.length) {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'At least one "To Address" has to be added!', { itemIndex: i });
                        }
                        if (additionalFields.configurationSetName) {
                            params.push(`ConfigurationSetName=${additionalFields.configurationSetName}`);
                        }
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=SendEmail&' + params.join('&'));
                    }
                    if (operation === 'sendTemplate') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=SendTemplatedEmail&' + params.join('&'));
                ...
                if (resource === 'template') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=CreateTemplate&' + params.join('&'));
                        responseData = responseData.CreateTemplateResponse;
                    }
                    if (operation === 'delete') {
                        const templateName = this.getNodeParameter('templateName', i);
                        const params = [`TemplateName=${templateName}`];
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=DeleteTemplate&' + params.join('&'));
                        responseData = responseData.DeleteTemplateResponse;
                    }
                    if (operation === 'get') {
                        const templateName = this.getNodeParameter('templateName', i);
                        const params = [`TemplateName=${templateName}`];
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=GetTemplate&' + params.join('&'));
                        responseData = responseData.GetTemplateResponse;
                    }
                    if (operation === 'getAll') {
                        const returnAll = this.getNodeParameter('returnAll', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListTemplatesResponse.ListTemplatesResult.TemplatesMetadata.member', 'email', 'POST', '/?Action=ListTemplates');
                        }
                        else {
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'GET', `/?Action=ListTemplates&MaxItems=${limit}`);
                            responseData =
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestSOAP.call(this, 'email', 'POST', '/?Action=UpdateTemplate&' + params.join('&'));
...
//# sourceMappingURL=AwsSes.node.js.map