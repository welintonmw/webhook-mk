            ...
            try {
                if (resource === 'image') {
                    if (operation === 'analyze') {
                        ...
                        body.Filters = {};
                        const box = ((_a = additionalFields.regionsOfInterestUi) === null || _a === void 0 ? void 0 : _a.regionsOfInterestValues) || [];
                        if (box.length !== 0) {
                            body.Filters.RegionsOfInterest = box.map((entry) => {
                                return { BoundingBox: (0, GenericFunctions_1.keysTPascalCase)(entry) };
                            });
                        }
                        ...
                        responseData = await GenericFunctions_1.awsApiRequestREST.call(this, 'rekognition', 'POST', '', JSON.stringify(body), {}, { 'X-Amz-Target': action, 'Content-Type': 'application/x-amz-json-1.1' });
                    }
                }
