            ...
            try {
                if (resource === 'agent') {
                    if (operation === 'create') {
                        ...
                        Object.assign(body, GenericFunctions_1.adjustAgentRoles(roles));
                        ...
                        if (Object.keys(filters).length) {
                            Object.assign(qs, GenericFunctions_1.formatFilters(filters));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const body = {
                            ...
                            visible_from: moment_timezone_1.tz(visibleFrom, defaultTimezone),
                        };
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            const { visible_till, additional_emails } = additionalFields, rest = __rest(additionalFields, ["visible_till", "additional_emails"]);
                            Object.assign(body, Object.assign(Object.assign(Object.assign({}, (additional_emails && { additional_emails: GenericFunctions_1.toArray(additional_emails) })), (visible_till && { visible_till: moment_timezone_1.tz(visible_till, defaultTimezone) })), rest));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            ...
                            Object.assign(body, Object.assign(Object.assign({}, (domains && { domains: GenericFunctions_1.toArray(domains) })), rest));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustAddress(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        GenericFunctions_1.validateUpdateFields.call(this, updateFields, resource);
                        Object.assign(body, GenericFunctions_1.adjustAddress(updateFields));
                        const locationId = this.getNodeParameter('locationId', i);
                        const endpoint = `/locations/${locationId}`;
                        responseData = await GenericFunctions_1.freshserviceApiRequest.call(this, 'PUT', endpoint, body);
                    }
                    ...
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            ...
                            Object.assign(body, Object.assign(Object.assign({}, (secondary_emails && { secondary_emails: GenericFunctions_1.toArray(secondary_emails) })), rest));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            ...
                            Object.assign(body, Object.assign(Object.assign({}, (cc_emails && { cc_emails: GenericFunctions_1.toArray(cc_emails) })), rest));
                        }
