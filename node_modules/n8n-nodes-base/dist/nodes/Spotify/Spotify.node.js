            ...
            try {
                if (resource === 'player') {
                    if (operation === 'pause') {
                        ...
                        responseData = await GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                        ...
                        const volumePercent = this.getNodeParameter('volumePercent', i);
                        qs = {
                    ...
                    if (operation === 'get') {
                        ...
                        const filters = this.getNodeParameter('filters', i);
                        qs = Object.assign({ q, type: 'album' }, filters);
                        if (returnAll === false) {
                            const limit = this.getNodeParameter('limit', i);
                            qs.limit = limit;
                            responseData = await GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                    ...
                    if (operation === 'getAlbums') {
                        ...
                        const q = this.getNodeParameter('query', i);
                        const filters = this.getNodeParameter('filters', i);
                        qs = Object.assign({ q, limit: 50, type: 'artist' }, filters);
                        if (returnAll === false) {
                            const limit = this.getNodeParameter('limit', i);
                            qs.limit = limit;
                            responseData = await GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                    ...
                    if (['delete', 'get', 'getTracks', 'add'].includes(operation)) {
                        ...
                        responseData = await GenericFunctions_1.spotifyApiRequest.call(this, 'POST', '/me/playlists', body, qs);
                    }
                    else if (operation === 'search') {
                        requestMethod = 'GET';
                        endpoint = '/search';
                        ...
                        const q = this.getNodeParameter('query', i);
                        const filters = this.getNodeParameter('filters', i);
                        qs = Object.assign({ q, type: 'playlist', limit: 50 }, filters);
                        if (returnAll === false) {
                            const limit = this.getNodeParameter('limit', i);
                            qs.limit = limit;
                            responseData = await GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                    ...
                    if (operation === 'getAudioFeatures') {
                        ...
                        const q = this.getNodeParameter('query', i);
                        const filters = this.getNodeParameter('filters', i);
                        qs = Object.assign({ q, type: 'track', limit: 50 }, filters);
                        if (returnAll === false) {
                            const limit = this.getNodeParameter('limit', i);
                            qs.limit = limit;
                            responseData = await GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                ...
                if (returnAll) {
                    responseData = await GenericFunctions_1.spotifyApiRequestAllItems.call(this, propertyName, requestMethod, endpoint, body, qs);
                }
...
//# sourceMappingURL=Spotify.node.js.map