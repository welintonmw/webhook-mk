        ...
        this.methods = {
            loadOptions: {
                async loadActiveAnalyzers() {
                    const requestResult = await GenericFunctions_1.cortexApiRequest.call(this, 'POST', '/analyzer/_search?range=all');
                    const returnData = [];
                ...
                async loadObservableOptions() {
                    ...
                    for (const dataType of requestResult.dataTypeList) {
                        returnData.push({
                            name: (0, upperFirst_1.default)(dataType),
                            value: dataType,
                        });
                    }
                    return returnData;
                    ...
                    if (operation === 'execute') {
                        ...
                        if (isJSON) {
                            ...
                            body = {
                                ...
                                data: {
                                    _type: entityType,
                                    ...(0, GenericFunctions_1.prepareParameters)(values),
                                },
                            };
                            if (entityType === 'alert') {
                            ...
                            body = {
                                label: (0, GenericFunctions_1.getEntityLabel)(body.data),
                                ...body,
                            };
                        }
