            ...
            try {
                ...
                if (resource === 'group') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.discourseApiRequest.call(this, 'POST', `/admin/groups.json`, { group: body });
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.discourseApiRequest.call(this, 'PUT', `/groups/${groupId}.json`, { group: body });
                    }
                }
                if (resource === 'post') {
                    if (operation === 'create') {
