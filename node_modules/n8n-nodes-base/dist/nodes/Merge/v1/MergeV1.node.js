    ...
    async execute() {
        ...
        if (mode === 'append') {
            ...
            for (entry of dataInput2) {
                const key = (0, get_1.default)(entry.json, propertyName2);
                if (!entry.json || !key) {
                    continue;
                }
                copyData[key] = entry;
            ...
            for (entry of dataInput1) {
                referenceValue = (0, get_1.default)(entry.json, propertyName1);
            ...
            const pairedItem = (0, utilities_1.generatePairedItemData)(this.getInputData(0).length);
