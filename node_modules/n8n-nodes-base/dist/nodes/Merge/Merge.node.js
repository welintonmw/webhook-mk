        ...
        if (mode === 'append') {
            ...
            for (entry1 of dataInput1) {
                for (entry2 of dataInput2) {
                    returnData.push({ json: Object.assign(Object.assign({}, (entry1.json)), (entry2.json)) });
                }
            }
            return [returnData];
        }
            ...
            for (entry of dataInput2) {
                const key = lodash_1.get(entry.json, propertyName2);
                if (!entry.json || !key) {
                    continue;
                }
                copyData[key] = entry;
            ...
            for (entry of dataInput1) {
                referenceValue = lodash_1.get(entry.json, propertyName1);
