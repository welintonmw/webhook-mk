    ...
    async execute() {
        ...
        if (mode === 'combine') {
            ...
            if (combinationMode === 'mergeByPosition') {
                ...
                let input1 = this.getInputData(0);
                let input2 = this.getInputData(1);
                if ((input1 === null || input1 === void 0 ? void 0 : input1.length) === 0 || (input2 === null || input2 === void 0 ? void 0 : input2.length) === 0) {
            ...
            if (combinationMode === 'mergeByFields') {
                ...
                if ((input1 === null || input1 === void 0 ? void 0 : input1.length) === 0 || (input2 === null || input2 === void 0 ? void 0 : input2.length) === 0) {
                    if (!(input1 === null || input1 === void 0 ? void 0 : input1.length) && joinMode === 'keepNonMatches' && outputDataFrom === 'input1')
                        return [returnData];
                    if (!(input2 === null || input2 === void 0 ? void 0 : input2.length) && joinMode === 'keepNonMatches' && outputDataFrom === 'input2')
                        return [returnData];
                    if (joinMode === 'keepMatches') {
                        return [[]];
                    }
                    else if (joinMode === 'enrichInput1' && (input1 === null || input1 === void 0 ? void 0 : input1.length) === 0) {
                        return [[]];
                    }
                    else if (joinMode === 'enrichInput2' && (input2 === null || input2 === void 0 ? void 0 : input2.length) === 0) {
                        return [[]];
                    }
                    else {
                        return [[...input1, ...input2]];
                ...
                if (joinMode === 'enrichInput1' || joinMode === 'enrichInput2') {
                    ...
                    if (joinMode === 'enrichInput1') {
                        if (clashResolveOptions.resolveClash === 'addSuffix') {
                            returnData.push(...mergedEntries, ...(0, GenericFunctions_1.addSuffixToEntriesKeys)(matches.unmatched1, '1'));
                        }
                        else {
                        ...
                        if (clashResolveOptions.resolveClash === 'addSuffix') {
                            returnData.push(...mergedEntries, ...(0, GenericFunctions_1.addSuffixToEntriesKeys)(matches.unmatched2, '2'));
                        }
                        else {
