            ...
            try {
                ...
                if (resource === 'file' && operation === 'upload') {
                    ...
                    for (const item of responseData) {
                        ...
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(newItem), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                }
                    ...
                    if (returnAll) {
                        data = simple ? (0, GenericFunctions_1.simplify)(responseData) : responseData;
                    }
                    else {
                        data = simple
                            ? (0, GenericFunctions_1.simplify)(responseData[property])
