...
exports.prepareNotionError = exports.extractBlockId = exports.simplifyBlocksOutput = exports.extractDatabaseMentionRLC = exports.validateJSON = exports.getSearchFilters = exports.extractDatabaseId = exports.extractPageId = exports.downloadFiles = exports.getConditions = exports.getFormattedChildren = exports.simplifyObjects = exports.getPropertyTitle = exports.simplifyProperties = exports.mapFilters = exports.mapSorting = exports.mapProperties = exports.formatBlocks = exports.formatText = exports.formatTitle = exports.getBlockTypesOptions = exports.notionApiRequestGetBlockChildrens = exports.notionApiRequestAllItems = exports.notionApiRequest = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const change_case_1 = require("change-case");
const moment_timezone_1 = __importDefault(require("moment-timezone"));
const uuid_1 = require("uuid");
const Filters_1 = require("./descriptions/Filters");
...
async function notionApiRequestGetBlockChildrens(blocks, responseData = [], limit) {
    ...
    for (const block of blocks) {
        ...
        if (block.has_children) {
            let childrens = await notionApiRequestAllItems.call(this, 'results', 'GET', `/blocks/${block.id}/children`);
...
exports.notionApiRequestGetBlockChildrens = notionApiRequestGetBlockChildrens;
...
exports.getBlockTypesOptions = getBlockTypesOptions;
...
function simplifyBlocksOutput(blocks, rootId) {
    ...
    for (const block of blocks) {
        ...
        try {
            ...
            const text = (_a = block[type]) === null || _a === void 0 ? void 0 : _a.text;
            if (text && Array.isArray(text)) {
                const content = text.map((entry) => entry.plain_text || '').join('');
                block.content = content;
                delete block[type];
...
exports.simplifyBlocksOutput = simplifyBlocksOutput;
function extractBlockId(nodeVersion, itemIndex) {
    let blockId;
    if (nodeVersion < 2.2) {
        blockId = extractPageId(this.getNodeParameter('blockId', itemIndex, '', { extractValue: true }));
    }
    else {
        ...
        if (blockIdRLCData.mode === 'id') {
            ...
            if (match === null) {
                const pageRegex = /(?:https|http):\/\/www\.notion\.so\/(?:[a-z0-9-]{2,}\/)?(?:[a-zA-Z0-9-]{2,}-)?([0-9a-f]{8}[0-9a-f]{4}4[0-9a-f]{3}[89ab][0-9a-f]{3}[0-9a-f]{12})/;
                const pageMatch = blockIdRLCData.value.match(pageRegex);
                if (pageMatch === null) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Invalid URL, could not find block ID or page ID', {
                        itemIndex,
                    });
                }
                else {
...
const prepareNotionError = (node, error, itemIndex) => {
    ...
    if (error instanceof n8n_workflow_1.NodeOperationError && ((_a = error === null || error === void 0 ? void 0 : error.context) === null || _a === void 0 ? void 0 : _a.itemIndex) === undefined) {
        (0, set_1.default)(error, 'context.itemIndex', itemIndex);
        return error;
    }
    return new n8n_workflow_1.NodeOperationError(node, error, { itemIndex });
};
exports.prepareNotionError = prepareNotionError;
