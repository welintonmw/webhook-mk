                    ...
                    if (operation === 'create') {
                        ...
                        if (additionalFields.startTime) {
                            if (additionalFields.timeZone) {
                                body.start_time = moment(additionalFields.startTime).format('YYYY-MM-DDTHH:mm:ss');
                            }
                            else {
                                body.start_time = moment.tz(additionalFields.startTime, this.getTimezone()).format();
                            }
                        }
