            ...
            loadOptions: {
                async getWorkspaces() {
                    try {
                        ...
                        const responseData = await GenericFunctions_1.apiRequest.call(this, requestMethod, endpoint, {}, {});
                ...
                async getBases() {
                    ...
                    try {
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), new Error(`Error while fetching ${version === 3 ? 'bases' : 'projects'}!`, {
                            cause: e,
                        }));
                    }
                },
                async getTables() {
                    ...
                    if (baseId) {
                        try {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), new Error('Error while fetching tables!', { cause: e }));
                        }
                    }
                    else {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `No  ${version === 3 ? 'base' : 'project'} selected!`);
                    }
                },
            },
        };
                    ...
                    if (dataToSend === 'autoMapInputData') {
                        ...
                        for (const field of fields) {
                            if (!field.binaryData) {
                                ...
                                responseData = await GenericFunctions_1.apiRequest.call(this, 'POST', postUrl, {}, version === 3 ? { base_id: baseId } : { project_id: baseId }, undefined, {
                                    formData,
                                });
                                newItem[field.fieldName] = JSON.stringify(Array.isArray(responseData) ? responseData : [responseData]);
                            }
                        }
                    }
                    body.push(newItem);
            ...
            if (operation === 'delete') {
                ...
                try {
                    ...
                    if (version === 1) {
                        ...
                        returnData.push(...responseData.map((result, index) => {
                            if (result === 0) {
                                const errorMessage = `The row with the ID "${body[index].id}" could not be deleted. It probably doesn't exist.`;
                                if (this.continueOnFail()) {
                                    return { error: errorMessage };
                                }
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), { message: errorMessage }, { message: errorMessage, itemIndex: index });
                            }
                            return {
                                success: true,
                            };
                ...
                try {
                    for (let i = 0; i < items.length; i++) {
                        ...
                        if (downloadAttachments) {
                            ...
                            const response = await GenericFunctions_1.downloadRecordAttachments.call(this, responseData, downloadFieldNames, [{ item: i }]);
                            data.push(...response);
                        }
                    }
                    if (downloadAttachments) {
                    ...
                    try {
                        ...
                        if (version === 2) {
                            if (Object.keys(responseData).length === 0) {
                                ...
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), { message: errorMessage }, { message: errorMessage, itemIndex: i });
                            }
                        }
                        ...
                        if (downloadAttachments) {
                            ...
                            const data = await GenericFunctions_1.downloadRecordAttachments.call(this, [responseData], downloadFieldNames, [{ item: i }]);
                            const newItem = {
