                ...
                if (resource === 'user') {
                    if (operation === 'create') {
                        ...
                        if (!jsonActive) {
                            ...
                            const dataAttributesJson = GenericFunctions_1.validateJSON(this.getNodeParameter('dataAttributesJson', i));
                ...
                if (resource === 'event') {
                    if (operation === 'track') {
                        ...
                        if (!jsonActive) {
                            ...
                            const extraAttributesJson = GenericFunctions_1.validateJSON(this.getNodeParameter('extraAttributesJson', i));
