...
class Summarize {
                    ...
                    options: [
                        {
                            ...
                            values: [
                                ...
                                },
                                {
                                    ...
                                    displayOptions: {
                                        hide: {
                                            aggregation: [...utils_1.NUMERICAL_AGGREGATIONS, 'countUnique', 'count', 'max', 'min'],
                                        },
                                    },
                                ...
                                },
                                {
                                    ...
                                    displayOptions: {
                                        show: {
                                            aggregation: utils_1.NUMERICAL_AGGREGATIONS,
                                        },
                                    },
                                    requiresDataPath: 'single',
                                },
    ...
    async execute() {
        ...
        const getValue = (0, utils_1.fieldValueGetter)(options.disableDotNotation);
        const nodeVersion = this.getNode().typeVersion;
        if (nodeVersion < 2.1) {
            try {
                utils_1.checkIfFieldExists.call(this, newItems, fieldsToSummarize, getValue);
            }
            catch (error) {
        ...
        const aggregationResult = (0, utils_1.splitData)(fieldsToSplitBy, newItems, fieldsToSummarize, options, getValue);
        if (options.outputFormat === 'singleItem') {
            ...
            const returnData = (0, utils_1.aggregationToArray)(aggregationResult, fieldsToSplitBy);
