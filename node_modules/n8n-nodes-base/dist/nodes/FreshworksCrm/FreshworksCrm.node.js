        ...
        this.methods = {
            loadOptions: {
                ...
                async getBusinessTypes() {
                    return await GenericFunctions_1.loadResource.call(this, 'business_types');
                },
                async getCampaigns() {
                    return await GenericFunctions_1.loadResource.call(this, 'campaigns');
                },
                async getContactStatuses() {
                    return await GenericFunctions_1.loadResource.call(this, 'contact_statuses');
                },
                ...
                async getDealPaymentStatuses() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_payment_statuses');
                },
                async getDealPipelines() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_pipelines');
                },
                async getDealProducts() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_products');
                },
                async getDealReasons() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_reasons');
                },
                async getDealStages() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_stages');
                },
                async getDealTypes() {
                    return await GenericFunctions_1.loadResource.call(this, 'deal_types');
                },
                async getDealViews() {
                ...
                async getIndustryTypes() {
                    return await GenericFunctions_1.loadResource.call(this, 'industry_types');
                },
                async getLifecycleStages() {
                    return await GenericFunctions_1.loadResource.call(this, 'lifecycle_stages');
                },
                async getOutcomes() {
                    return await GenericFunctions_1.loadResource.call(this, 'sales_activity_outcomes');
                },
                async getSalesActivityTypes() {
                    return await GenericFunctions_1.loadResource.call(this, 'sales_activity_types');
                },
                async getTerritories() {
                    return await GenericFunctions_1.loadResource.call(this, 'territories');
                },
                async getUsers() {
            ...
            try {
                if (resource === 'account') {
                    ...
                    if (operation === 'create') {
                        ...
                        const start = moment_timezone_1.tz(startDate, timezone);
                        const end = moment_timezone_1.tz(endDate, timezone);
                        const body = {
                        ...
                        Object.assign(body, additionalFields);
                        if (attendees.length) {
                            body['appointment_attendees_attributes'] = GenericFunctions_1.adjustAttendees(attendees);
                        }
                        ...
                        if (from_date) {
                            body.from_date = moment_timezone_1.tz(from_date, timezone).format();
                        }
                        if (end_date) {
                            body.end_date = moment_timezone_1.tz(end_date, timezone).format();
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustAccounts(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustAccounts(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const body = {
                            ...
                            start_date: moment_timezone_1.tz(startDate, defaultTimezone).format(),
                            end_date: moment_timezone_1.tz(endDate, defaultTimezone).format(),
                            targetable_type: this.getNodeParameter('targetableType', i),
                            targetable_id: this.getNodeParameter('targetable_id', i),
                        };
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        ...
                        responseData = await GenericFunctions_1.freshworksCrmApiRequest.call(this, 'POST', '/sales_activities', { sales_activity: body });
                        ...
                        const { from_date, end_date } = updateFields, rest = __rest(updateFields, ["from_date", "end_date"]);
                        if (from_date) {
                            body.from_date = moment_timezone_1.tz(from_date, defaultTimezone).format();
                        }
                        if (end_date) {
                            body.end_date = moment_timezone_1.tz(end_date, defaultTimezone).format();
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const body = {
                            title: this.getNodeParameter('title', i),
                            owner_id: this.getNodeParameter('ownerId', i),
                            due_date: moment_timezone_1.tz(dueDate, defaultTimezone).format(),
                            targetable_type: this.getNodeParameter('targetableType', i),
                            targetable_id: this.getNodeParameter('targetable_id', i),
                        };
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        ...
                        if (dueDate) {
                            body.due_date = moment_timezone_1.tz(dueDate, defaultTimezone).format();
                        }
                        if (Object.keys(rest).length) {
                            Object.assign(body, rest);
                        }
