...
async function freshworksCrmApiRequest(method, endpoint, body = {}, qs = {}) {
    const { apiKey, domain } = await this.getCredentials('freshworksCrmApi');
    const options = {
        headers: {
...
function adjustAccounts(additionalFields) {
    ...
    return Object.assign(Object.assign({}, lodash_1.omit(additionalFields, ['sales_accounts'])), { sales_accounts: adjusted });
}
