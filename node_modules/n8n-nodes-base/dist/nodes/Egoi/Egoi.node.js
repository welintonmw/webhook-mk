                ...
                if (resource === 'contact') {
                    if (operation === 'create') {
                        ...
                        if (additionalFields.birth_date) {
                            additionalFields.birth_date = moment(additionalFields.birth_date).format('YYYY-MM-DD');
                        }
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.birth_date) {
                            updateFields.birth_date = moment(updateFields.birth_date).format('YYYY-MM-DD');
                        }
