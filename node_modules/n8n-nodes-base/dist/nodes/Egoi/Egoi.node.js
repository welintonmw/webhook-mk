    ...
    constructor() {
        this.description = {
            ...
            properties: [
                ...
                },
                {
                    ...
                    default: '',
                    description: 'ID of list to operate on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Email',
                    name: 'email',
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            default: [],
                            description: 'List of tag IDs to be added. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                    ],
                },
                {
        ...
        this.methods = {
            loadOptions: {
                async getLists() {
                    const returnData = [];
                    const lists = await GenericFunctions_1.egoiApiRequestAllItems.call(this, 'items', 'GET', '/lists');
                ...
                async getExtraFields() {
                    ...
                    const extraFields = await GenericFunctions_1.egoiApiRequest.call(this, 'GET', `/lists/${listId}/fields`);
                ...
                async getListTags() {
                    const returnData = [];
                    const tagList = await GenericFunctions_1.egoiApiRequestAllItems.call(this, 'items', 'GET', '/tags');
                ...
                if (resource === 'contact') {
                    if (operation === 'create') {
                        ...
                        if (additionalFields.extraFieldsUi) {
                            const extraFields = additionalFields.extraFieldsUi
                                .extraFieldValues;
                            if (extraFields) {
                        ...
                        responseData = await GenericFunctions_1.egoiApiRequest.call(this, 'POST', `/lists/${listId}/contacts`, body);
                        const contactId = responseData.contact_id;
                        if (additionalFields.tagIds) {
                            const tags = additionalFields.tagIds;
                            for (const tag of tags) {
                                await GenericFunctions_1.egoiApiRequest.call(this, 'POST', `/lists/${listId}/contacts/actions/attach-tag`, { tag_id: tag, contacts: [contactId] });
                            }
                        }
                        if (resolveData) {
                            responseData = await GenericFunctions_1.egoiApiRequest.call(this, 'GET', `/lists/${listId}/contacts/${contactId}`);
                        }
                    }
                    if (operation === 'get') {
                        const listId = this.getNodeParameter('list', i);
                        ...
                        responseData = await GenericFunctions_1.egoiApiRequest.call(this, 'GET', endpoint, {});
                        if (responseData.items) {
                            responseData = responseData.items;
                        }
                        if (simple) {
                            const data = (await GenericFunctions_1.simplify.call(this, [responseData], listId))[0];
                            responseData = {
                                ...data,
                    ...
                    if (operation === 'getAll') {
                        ...
                        const simple = this.getNodeParameter('simple', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_1.egoiApiRequestAllItems.call(this, 'items', 'GET', `/lists/${listId}/contacts`, {});
                        }
                        else {
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.egoiApiRequest.call(this, 'GET', `/lists/${listId}/contacts`, {}, { limit });
                            responseData = responseData.items;
                        }
                        if (simple) {
                            responseData = await GenericFunctions_1.simplify.call(this, responseData, listId);
                        }
                    }
                    if (operation === 'update') {
                        const listId = this.getNodeParameter('list', i);
                        ...
                        if (updateFields.extraFieldsUi) {
                            const extraFields = updateFields.extraFieldsUi
                                .extraFieldValues;
                            if (extraFields) {
                                body.extra = extraFields;
                            }
                        ...
                        responseData = await GenericFunctions_1.egoiApiRequest.call(this, 'PATCH', `/lists/${listId}/contacts/${contactId}`, body);
