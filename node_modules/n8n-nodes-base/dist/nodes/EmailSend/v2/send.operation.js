    ...
    for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
        try {
            ...
            if (appendAttribution) {
                ...
                const link = `https://n8n.io/?utm_source=n8n-internal&utm_medium=powered_by&utm_campaign=${encodeURIComponent('n8n-nodes-base.emailSend')}${instanceId ? '_' + instanceId : ''}`;
