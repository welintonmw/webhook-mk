        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    endpoint = `/targets`;
                    const targets = await GenericFunctions_1.zendeskApiRequestAllItems.call(this, 'targets', 'GET', endpoint);
                ...
                async create() {
                    ...
                    if (service === 'support') {
                        ...
                        const urlParts = url_1.parse(webhookUrl);
                        const bodyTrigger = {
                            trigger: {
                        ...
                        if (webhookData.targetId !== undefined) {
                            ...
                            target = await GenericFunctions_1.zendeskApiRequest.call(this, 'POST', '/targets', bodyTarget);
                ...
                async delete() {
                    ...
                    try {
                        ...
                        await GenericFunctions_1.zendeskApiRequest.call(this, 'DELETE', `/targets/${webhookData.targetId}`);
                    }
                    catch (error) {
                        return false;
                    }
