...
class ShopifyTrigger {
        ...
        this.webhookMethods = {
            default: {
                ...
                async create() {
                    ...
                    const responseData = await GenericFunctions_1.shopifyApiRequest.call(this, 'POST', endpoint, body);
    ...
    async webhook() {
        ...
        if (headerData['x-shopify-topic'] !== undefined &&
            ...
            const computedSignature = (0, crypto_1.createHmac)('sha256', secret).update(req.rawBody).digest('base64');
