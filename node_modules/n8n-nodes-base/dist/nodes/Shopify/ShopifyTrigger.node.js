...
class ShopifyTrigger {
        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    const { webhooks } = await GenericFunctions_1.shopifyApiRequest.call(this, 'GET', endpoint, {}, { topic });
                ...
                async create() {
                    ...
                    let responseData;
                    responseData = await GenericFunctions_1.shopifyApiRequest.call(this, 'POST', endpoint, body);
                ...
                async delete() {
                    ...
                    if (webhookData.webhookId !== undefined) {
                        ...
                        try {
                            await GenericFunctions_1.shopifyApiRequest.call(this, 'DELETE', endpoint, {});
                        }
                        catch (error) {
                            return false;
                        }
    ...
    async webhook() {
        ...
        if (headerData['x-shopify-topic'] !== undefined
            ...
            const computedSignature = crypto_1.createHmac('sha256', credentials.sharedSecret).update(req.rawBody).digest('base64');
