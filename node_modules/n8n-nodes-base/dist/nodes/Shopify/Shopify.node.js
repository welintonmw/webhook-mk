            ...
            try {
                if (resource === 'order') {
                    if (operation === 'create') {
                        ...
                        const body = {
                            test: true,
                            line_items: GenericFunctions_1.keysToSnakeCase(lineItem),
                        };
                        ...
                        if (billing) {
                            body.billing_address = GenericFunctions_1.keysToSnakeCase(billing.billingAddressValues)[0];
                        }
                        if (shipping) {
                            body.shipping_address = GenericFunctions_1.keysToSnakeCase(shipping.shippingAddressValues)[0];
                        }
                        responseData = await GenericFunctions_1.shopifyApiRequest.call(this, 'POST', '/orders.json', { order: body });
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.shopifyApiRequest.call(this, 'PUT', `/orders/${orderId}.json`, { order: body });
                        responseData = responseData.order;
                    }
                }
                    ...
                    if (operation === 'create') {
                        ...
                        body.title = title;
                        responseData = await GenericFunctions_1.shopifyApiRequest.call(this, 'POST', '/products.json', { product: body });
