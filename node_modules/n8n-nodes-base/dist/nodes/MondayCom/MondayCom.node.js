            ...
            try {
                ...
                if (resource === 'boardItem') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.mondayComApiPaginatedRequest.call(this, 'data.boards[0].groups[0].items_page', fieldsToReturn, body);
                        }
                        else {
                            body.variables.limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.mondayComApiRequest.call(this, body);
                    ...
                    if (operation === 'getByColumnValue') {
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.mondayComApiPaginatedRequest.call(this, 'data.items_page_by_column_values', fieldsToReturn, body);
                        }
                        else {
                            body.variables.limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.mondayComApiRequest.call(this, body);
