...
exports.getAllFields = exports.getFields = exports.facebookApiRequest = void 0;
...
function getFields(object) {
    ...
    return [{ name: '*', value: '*' }].concat(data[object] || [])
        .map((fieldObject) => (Object.assign(Object.assign({}, fieldObject), { name: (fieldObject.value !== '*') ? change_case_1.capitalCase(fieldObject.value) : fieldObject.value })));
}
exports.getFields = getFields;
function getAllFields(object) {
    return getFields(object).filter((field) => field.value !== '*').map((field) => field.value);
}
