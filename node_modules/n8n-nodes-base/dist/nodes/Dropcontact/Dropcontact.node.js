...
class Dropcontact {
    constructor() {
        ...
        this.methods = {
            credentialTest: {
                async dropcontactApiCredentialTest(credential) {
                    try {
                        await GenericFunction_1.validateCrendetials.call(this, credential.data);
                    }
                    catch (error) {
                        return {
                            status: 'Error',
            ...
            if (operation === 'enrich') {
                ...
                if (!responseData.success) {
                    if (this.continueOnFail()) {
                        ...
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), { error: responseData.reason || 'invalid request' });
                    }
                }
                if (simplify === false) {
