            ...
            try {
                    ...
                    if (operation === 'create') {
                        ...
                        if (jsonParameters) {
                            ...
                            if (additionalFields.expires) {
                                body.expires = (0, moment_timezone_1.default)(additionalFields.expires).format('YYYY-MM-DD');
                            }
                ...
                if (resource === 'payment') {
                    if (operation === 'getAll') {
                        ...
                        if (jsonParameters) {
                            ...
                            if (additionalFields.from) {
                                body.from = (0, moment_timezone_1.default)(additionalFields.from).format('YYYY-MM-DD');
                            }
                            if (additionalFields.to) {
                                body.to = (0, moment_timezone_1.default)(additionalFields.to).format('YYYY-MM-DD');
                            }
                    ...
                    if (operation === 'reschedule') {
                        ...
                        body.date = body.to = (0, moment_timezone_1.default)(date).format('YYYY-MM-DD');
