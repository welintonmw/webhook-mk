...
import { BaserowCredentials, LoadedResource } from './types';
export declare function baserowApiRequest(this: IExecuteFunctions | ILoadOptionsFunctions, method: string, endpoint: string, body: IDataObject | undefined, qs: IDataObject | undefined, jwtToken: string): Promise<any>;
export declare function baserowApiRequestAllItems(this: IExecuteFunctions, method: string, endpoint: string, body: IDataObject, qs: IDataObject | undefined, jwtToken: string): Promise<IDataObject[]>;
