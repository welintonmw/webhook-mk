                ...
                if (resource === 'member') {
                    if (operation === 'create') {
                        ...
                        if (options.timestampOpt) {
                            body.timestamp_opt = moment(options.timestampOpt).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (options.timestampSignup) {
                            body.timestamp_signup = moment(options.timestampSignup).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (options.tags) {
                        ...
                        if (!jsonActive) {
                            ...
                            const locationJson = GenericFunctions_1.validateJSON(this.getNodeParameter('locationJson', i));
                            const mergeFieldsJson = GenericFunctions_1.validateJSON(this.getNodeParameter('mergeFieldsJson', i));
                            const groupJson = GenericFunctions_1.validateJSON(this.getNodeParameter('groupJson', i));
                            if (locationJson) {
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.timestampOpt) {
                            body.timestamp_opt = moment(updateFields.timestampOpt).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (updateFields.timestampSignup) {
                            body.timestamp_signup = moment(updateFields.timestampSignup).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (!jsonActive) {
