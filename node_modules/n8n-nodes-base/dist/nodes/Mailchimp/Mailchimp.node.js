                ...
                if (resource === 'member') {
                    if (operation === 'create') {
                        ...
                        if (options.timestampOpt) {
                            body.timestamp_opt = (0, moment_timezone_1.default)(options.timestampOpt).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (options.timestampSignup) {
                            body.timestamp_signup = (0, moment_timezone_1.default)(options.timestampSignup).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (options.tags) {
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.timestampOpt) {
                            body.timestamp_opt = (0, moment_timezone_1.default)(updateFields.timestampOpt).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (updateFields.timestampSignup) {
                            body.timestamp_signup = (0, moment_timezone_1.default)(updateFields.timestampSignup).format('YYYY-MM-DD HH:MM:SS');
                        }
                        if (!jsonActive) {
