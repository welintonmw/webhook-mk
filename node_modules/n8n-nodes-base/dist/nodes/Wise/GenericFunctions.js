...
exports.testPublicKey = exports.livePublicKey = exports.getTriggerName = exports.wiseApiRequest = void 0;
...
async function wiseApiRequest(method, endpoint, body = {}, qs = {}, option = {}) {
    ...
    if (response.statusCode === 403 && response.headers['x-2fa-approval']) {
        ...
        const signerObject = (0, crypto_1.createSign)('RSA-SHA256').update(oneTimeToken);
        try {
...
exports.wiseApiRequest = wiseApiRequest;
