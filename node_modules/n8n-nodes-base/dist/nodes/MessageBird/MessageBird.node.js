            ...
            try {
                ...
                if (resource === 'sms') {
                    if (operation === 'send') {
                        ...
                        const originator = this.getNodeParameter('originator', i);
                        ...
                        if (additionalFields.groupIds) {
                            bodyRequest.groupIds = additionalFields.groupIds;
                        }
                        if (additionalFields.type) {
                            bodyRequest.type = additionalFields.type;
                        }
                        if (additionalFields.reference) {
                            bodyRequest.reference = additionalFields.reference;
                        }
                        if (additionalFields.reportUrl) {
                            bodyRequest.reportUrl = additionalFields.reportUrl;
                        }
                        if (additionalFields.validity) {
                            bodyRequest.validity = additionalFields.reportUrl;
                        }
                        if (additionalFields.gateway) {
                            bodyRequest.gateway = additionalFields.gateway;
                        }
                        if (additionalFields.typeDetails) {
                            bodyRequest.typeDetails = additionalFields.typeDetails;
                        }
                        if (additionalFields.datacoding) {
                            bodyRequest.datacoding = additionalFields.datacoding;
                        }
                        if (additionalFields.mclass) {
                            bodyRequest.mclass = additionalFields.mclass;
                        }
                        if (additionalFields.scheduledDatetime) {
                            bodyRequest.scheduledDatetime = additionalFields.scheduledDatetime;
                        }
                        if (additionalFields.createdDatetime) {
                            bodyRequest.createdDatetime = additionalFields.createdDatetime;
                        }
                        const receivers = this.getNodeParameter('recipients', i);
                ...
                const responseData = await GenericFunctions_1.messageBirdApiRequest.call(this, requestMethod, requestPath, bodyRequest, qs);
...
exports.MessageBird = MessageBird;
//# sourceMappingURL=MessageBird.node.js.map