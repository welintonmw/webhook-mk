        ...
        this.methods = {
            credentialTest: {
                async strapiApiTest(credential) {
                    ...
                    let options = {};
                    const url = (0, GenericFunctions_1.removeTrailingSlash)(credentials.url);
                    options = {
                        headers: {
                ...
                if (resource === 'entry') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (apiVersion === 'v4') {
                            ...
                            if (returnAll) {
                                responseData = await GenericFunctions_1.strapiApiRequestAllItems.call(this, 'GET', `/${contentType}`, {}, qs, headers, apiVersion);
                            }
                            else {
