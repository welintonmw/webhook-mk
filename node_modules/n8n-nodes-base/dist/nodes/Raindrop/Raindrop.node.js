            ...
            try {
                if (resource === 'bookmark') {
                    ...
                    if (operation === 'create') {
                        ...
                        Object.assign(body, lodash_1.omit(updateFields, 'binaryPropertyName'));
                        const endpoint = `/collection/${collectionId}`;
                        responseData = await GenericFunctions_1.raindropApiRequest.call(this, 'PUT', endpoint, {}, body);
                        responseData = responseData.item;
                        if (updateFields.cover) {
                            ...
                            responseData = await GenericFunctions_1.raindropApiRequest.call(this, 'PUT', endpoint, {}, {}, { 'Content-Type': 'multipart/form-data', formData });
                            responseData = responseData.item;
                        }
                    }
                }
