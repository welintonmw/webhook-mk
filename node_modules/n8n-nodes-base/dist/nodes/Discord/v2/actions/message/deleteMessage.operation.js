...
const properties = [common_description_1.channelRLC, common_description_1.messageIdString];
...
async function execute(_guildId, userGuilds) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            await transport_1.discordApiRequest.call(this, 'DELETE', `/channels/${channelId}/messages/${messageId}`);
...
//# sourceMappingURL=deleteMessage.operation.js.map