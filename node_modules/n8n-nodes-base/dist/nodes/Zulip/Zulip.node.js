                ...
                if (resource === 'message') {
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.propagateMode) {
                            body.propagat_mode = change_case_1.snakeCase(updateFields.propagateMode);
                        }
                    ...
                    if (operation === 'updateFile') {
                        ...
                        const formData = {
                            file: {
                                value: Buffer.from(items[i].binary[binaryProperty].data, n8n_core_1.BINARY_ENCODING),
                                options: {
                    ...
                    if (operation === 'create') {
                        ...
                        if (jsonParameters) {
                            ...
                            if (additionalFieldsJson !== '') {
                                if (GenericFunctions_2.validateJSON(additionalFieldsJson) !== undefined) {
