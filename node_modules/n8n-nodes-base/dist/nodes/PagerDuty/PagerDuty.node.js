            ...
            try {
                if (resource === 'incident') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (options.include) {
                            options.include = options.include.map((e) => change_case_1.snakeCase(e));
                        }
                        if (options.sortBy) {
                            options.sortBy = options.sortBy;
                        }
                        Object.assign(qs, GenericFunctions_1.keysToSnakeCase(options)[0]);
                        if (returnAll) {
                ...
                if (resource === 'logEntry') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        GenericFunctions_1.keysToSnakeCase(qs);
                        const returnAll = this.getNodeParameter('returnAll', 0);
                        if (returnAll) {
