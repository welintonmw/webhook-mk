            ...
            try {
                ...
                if (resource === 'comment') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.clickupApiRequest.call(this, 'POST', `/${resource}/${id}/comment`, body);
                    }
                    if (operation === 'delete') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await GenericFunctions_1.clickupApiRequest.call(this, 'GET', `/${resource}/${id}/comment`, {}, qs);
                ...
                if (resource === 'task') {
                    if (operation === 'create') {
                        ...
                        if (additionalFields.customFieldsJson) {
                            const customFields = GenericFunctions_1.validateJSON(additionalFields.customFieldsJson);
                    ...
                    if (operation === 'setCustomField') {
                        ...
                        body.value = value;
                        if (jsonParse === true) {
                            body.value = GenericFunctions_1.validateJSON(body.value);
                ...
                if (resource === 'taskTag') {
                    if (operation === 'add') {
                        ...
                        responseData = await GenericFunctions_1.clickupApiRequest.call(this, 'POST', `/task/${taskId}/tag/${name}`, {}, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'remove') {
                        const taskId = this.getNodeParameter('taskId', i);
                        ...
                        const qs = {};
                        Object.assign(qs, additionalFields);
                        responseData = await GenericFunctions_1.clickupApiRequest.call(this, 'DELETE', `/task/${taskId}/tag/${name}`, {}, qs);
                        responseData = { success: true };
                    }
                }
