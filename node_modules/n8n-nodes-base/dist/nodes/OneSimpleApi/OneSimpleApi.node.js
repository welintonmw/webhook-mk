            ...
            try {
                ...
                if (resource === 'socialProfile') {
                    if (operation === 'instagramProfile') {
                        ...
                        responseData = await GenericFunctions_1.oneSimpleApiRequest.call(this, 'GET', '/instagram_profile', {}, qs);
                    }
                    if (operation === 'spotifyArtistProfile') {
                        const artistName = this.getNodeParameter('artistName', i);
                        qs.profile = artistName;
                        responseData = await GenericFunctions_1.oneSimpleApiRequest.call(this, 'GET', '/spotify_profile', {}, qs);
                    }
                }
