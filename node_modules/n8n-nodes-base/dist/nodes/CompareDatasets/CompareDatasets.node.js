...
class CompareDatasets {
    ...
    async execute() {
        ...
        if (options.nodeVersion >= 2) {
            options.fuzzyCompare = this.getNodeParameter('fuzzyCompare', 0, false);
        }
        let input1 = this.getInputData(0);
        let input2 = this.getInputData(1);
        if (options.nodeVersion < 2.2) {
            input1 = (0, GenericFunctions_1.checkInputAndThrowError)(input1, matchFields.map((pair) => pair.field1), options.disableDotNotation || false, 'Input A');
            input2 = (0, GenericFunctions_1.checkInputAndThrowError)(input2, matchFields.map((pair) => pair.field2), options.disableDotNotation || false, 'Input B');
        }
        else {
            input1 = (0, GenericFunctions_1.checkInput)(input1);
            input2 = (0, GenericFunctions_1.checkInput)(input2);
        }
