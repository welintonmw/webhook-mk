...
class AirtableV1 {
    ...
    async execute() {
        ...
        if (authentication === 'airtableApi') {
            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'The API Key connection was deprecated by Airtable, please use Access Token or OAuth2 instead.');
        }
        ...
        if (operation === 'append') {
            ...
            try {
                ...
                if (downloadAttachments === true) {
                    ...
                    const data = await GenericFunctions_1.downloadRecordAttachments.call(this, responseData.records, downloadFieldNames, pairedItem);
                    return [data];
                }
...
exports.AirtableV1 = AirtableV1;
//# sourceMappingURL=AirtableV1.node.js.map