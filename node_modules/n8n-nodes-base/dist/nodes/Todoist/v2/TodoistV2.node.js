        ...
        this.methods = {
            ...
            loadOptions: {
                ...
                async getSections() {
                    ...
                    const projectId = (_a = options.projectId) !== null && _a !== void 0 ? _a : this.getCurrentNodeParameter('project', { extractValue: true });
                    if (projectId) {
                ...
                async getItems() {
                    ...
                    if (projectId) {
                        ...
                        const items = await GenericFunctions_1.todoistApiRequest.call(this, 'GET', '/tasks', {}, qs);
    ...
    async execute() {
        ...
        for (let i = 0; i < length; i++) {
            try {
                ...
                if (responseData !== undefined && Array.isArray(responseData === null || responseData === void 0 ? void 0 : responseData.data)) {
                    ...
                    if (responseData === null || responseData === void 0 ? void 0 : responseData.hasOwnProperty('success')) {
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray({ success: responseData.success }), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else {
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData === null || responseData === void 0 ? void 0 : responseData.data), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                }
            }
