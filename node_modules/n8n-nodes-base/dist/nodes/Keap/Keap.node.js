        ...
        for (let i = 0; i < length; i++) {
            if (resource === 'company') {
                if (operation === 'create') {
                    ...
                    GenericFunctions_1.keysToSnakeCase(additionalFields);
                    Object.assign(body, additionalFields);
                    if (addresses) {
                        body.address = GenericFunctions_1.keysToSnakeCase(addresses)[0];
                    }
                    if (faxes) {
                ...
                if (operation === 'getAll') {
                    ...
                    GenericFunctions_1.keysToSnakeCase(options);
            ...
            if (resource === 'contact') {
                if (operation === 'upsert') {
                    ...
                    const additionalFields = this.getNodeParameter('additionalFields', i);
                    const body = {
                        duplicate_option: change_case_1.pascalCase(duplicateOption),
                    };
                    ...
                    if (addresses) {
                        body.addresses = GenericFunctions_1.keysToSnakeCase(addresses);
                    }
                    if (emails) {
            ...
            if (resource === 'contactNote') {
                if (operation === 'create') {
                    ...
                    if (additionalFields.type) {
                        additionalFields.type = change_case_1.pascalCase(additionalFields.type);
                    }
                    Object.assign(body, additionalFields);
                ...
                if (operation === 'getAll') {
                    ...
                    GenericFunctions_1.keysToSnakeCase(filters);
            ...
            if (resource === 'ecommerceOrder') {
                if (operation === 'create') {
                    ...
                    const body = {
                        ...
                        order_type: change_case_1.pascalCase(orderType),
                    };
                    ...
                    GenericFunctions_1.keysToSnakeCase(additionalFields);
                    Object.assign(body, additionalFields);
                    body.order_items = GenericFunctions_1.keysToSnakeCase(orderItems);
                    if (shippingAddress) {
                        body.shipping_address = GenericFunctions_1.keysToSnakeCase(shippingAddress)[0];
                    }
            ...
            if (resource === 'email') {
                if (operation === 'createRecord') {
                    ...
                    Object.assign(body, additionalFields);
                    GenericFunctions_1.keysToSnakeCase(body);
                ...
                if (operation === 'send') {
                    ...
                    if (attachmentsUi) {
                        if (attachmentsUi.attachmentsValues) {
                            GenericFunctions_1.keysToSnakeCase(attachmentsUi.attachmentsValues);
            ...
            if (resource === 'file') {
                ...
                if (operation === 'getAll') {
                    ...
                    if (qs.type) {
                        qs.type = change_case_1.capitalCase(qs.type);
                    }
                    if (qs.viewable) {
