...
exports.getProductAttributes = exports.sort = exports.getOrderFields = exports.getProductOptionalFields = exports.getCustomerOptionalFields = exports.validateJSON = exports.getFilterQuery = exports.getSearchFilters = exports.adjustAddresses = exports.getAddressesUi = exports.magentoApiRequestAllItems = exports.magentoApiRequest = void 0;
const n8n_workflow_1 = require("n8n-workflow");
async function magentoApiRequest(method, resource, body = {}, qs = {}, uri, _headers = {}, option = {}) {
...
exports.magentoApiRequest = magentoApiRequest;
async function magentoApiRequestAllItems(propertyName, method, resource, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    do {
        responseData = await magentoApiRequest.call(this, method, resource, body, query);
        returnData.push.apply(returnData, responseData[propertyName]);
        query.current_page = query.current_page ? query.current_page++ : 1;
    } while (returnData.length < responseData.total_count);
    return returnData;
}
exports.magentoApiRequestAllItems = magentoApiRequestAllItems;
function getAddressesUi() {
    return {
...
exports.getAddressesUi = getAddressesUi;
function adjustAddresses(addresses) {
    var _a;
    const _addresses = [];
    for (let i = 0; i < addresses.length; i++) {
        if (((_a = addresses[i]) === null || _a === void 0 ? void 0 : _a.region) === '') {
...
function getFilterQuery(data) {
    var _a, _b, _c;
    if (!data.hasOwnProperty('conditions') || ((_a = data.conditions) === null || _a === void 0 ? void 0 : _a.length) === 0) {
        throw new n8n_workflow_1.ApplicationError('At least one filter has to be set', { level: 'warning' });
    }
    if (data.matchType === 'anyFilter') {
        return {
            search_criteria: {
                filter_groups: [
                    {
                        filters: data === null || data === void 0 ? void 0 : data.conditions,
                    },
                ],
    ...
    else if (((_b = data.conditions) === null || _b === void 0 ? void 0 : _b.length) !== 0) {
        return {
            search_criteria: {
                filter_groups: (_c = data === null || data === void 0 ? void 0 : data.conditions) === null || _c === void 0 ? void 0 : _c.map((filter) => {
                    return {
                        filters: [filter],
                    };
                }),
...
exports.sort = sort;
async function getProductAttributes(filter, extraValue) {
    let attributes = await magentoApiRequestAllItems.call(this, 'items', 'GET', '/rest/default/V1/products/attributes', {}, {
        search_criteria: 0,
    });
    attributes = attributes.filter((attribute) => attribute.default_frontend_label !== undefined && attribute.default_frontend_label !== '');
    if (filter) {
    ...
    return returnData.sort(exports.sort);
}
