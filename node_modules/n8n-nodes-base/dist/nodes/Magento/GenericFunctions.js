...
async function magentoApiRequest(method, resource, body = {}, qs = {}, uri, headers = {}, option = {}) {
...
function adjustAddresses(addresses) {
    ...
    for (let i = 0; i < addresses.length; i++) {
        ...
        _addresses.push(Object.assign(Object.assign({}, addresses[i]), { street: [addresses[i].street] }));
    }
    return _addresses;
}
