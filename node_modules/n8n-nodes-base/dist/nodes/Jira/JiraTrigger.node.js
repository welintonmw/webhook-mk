            ...
            default: {
                async checkExists() {
                    ...
                    for (const webhook of webhooks) {
                        if (webhook.url === webhookUrl && GenericFunctions_1.eventExists(events, webhook.events)) {
                            webhookData.webhookId = GenericFunctions_1.getId(webhook.self);
                            return true;
                        }
                    }
                    return false;
                ...
                async create() {
                    ...
                    webhookData.webhookId = GenericFunctions_1.getId(responseData.self);
                    return true;
                },
                async delete() {
                    const webhookData = this.getWorkflowStaticData('node');
