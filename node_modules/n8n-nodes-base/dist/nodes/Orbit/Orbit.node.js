                ...
                if (resource === 'member') {
                    if (operation === 'upsert') {
                        ...
                        if (additionalFields.birthday) {
                            member.birthday = (0, moment_timezone_1.default)(additionalFields.birthday).format('MM-DD-YYYY');
                        }
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.birthday) {
                            body.birthday = (0, moment_timezone_1.default)(updateFields.birthday).format('MM-DD-YYYY');
                        }
