                ...
                if (resource === 'member') {
                    if (operation === 'upsert') {
                        ...
                        if (additionalFields.birthday) {
                            member.birthday = moment(additionalFields.birthday).format('MM-DD-YYYY');
                        }
                        ...
                        responseData = await GenericFunctions_1.orbitApiRequest.call(this, 'POST', `/${workspaceId}/members`, { member, identity });
                        responseData = responseData.data;
                    }
                    if (operation === 'delete') {
                        const workspaceId = this.getNodeParameter('workspaceId', i);
                    ...
                    if (operation === 'get') {
                        ...
                        if (resolve === true) {
                            GenericFunctions_1.resolveIdentities(responseData);
                        }
                        responseData = responseData.data;
                    }
                    if (operation === 'getAll') {
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.birthday) {
                            body.birthday = moment(updateFields.birthday).format('MM-DD-YYYY');
                        }
