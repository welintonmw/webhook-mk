            ...
            try {
                ...
                if (resource === 'invoice') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'POST', '/invoices', body);
                        responseData = responseData.data;
                    }
                    if (operation === 'email') {
                        const invoiceId = this.getNodeParameter('invoiceId', i);
                        responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'POST', '/email_invoice', { id: invoiceId });
                    }
                    if (operation === 'get') {
                        const invoiceId = this.getNodeParameter('invoiceId', i);
                        const options = this.getNodeParameter('options', i);
                ...
                if (resource === 'quote') {
                    ...
                    if (operation === 'email') {
                        ...
                        responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'POST', '/email_invoice', { id: quoteId });
                    }
                    if (operation === 'get') {
                        const quoteId = this.getNodeParameter('quoteId', i);
                        const options = this.getNodeParameter('options', i);
                        ...
                        responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'GET', `/invoices/${quoteId}`, {}, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'getAll') {
                        const returnAll = this.getNodeParameter('returnAll', 0);
                        ...
                        if (returnAll === true) {
                            responseData = await GenericFunctions_1.invoiceNinjaApiRequestAllItems.call(this, 'data', 'GET', '/quotes', {}, qs);
                        }
                        else {
                            qs.per_page = this.getNodeParameter('limit', 0);
                            responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'GET', '/quotes', {}, qs);
                            responseData = responseData.data;
                        }
                    }
                    if (operation === 'delete') {
                        const quoteId = this.getNodeParameter('quoteId', i);
                        responseData = await GenericFunctions_1.invoiceNinjaApiRequest.call(this, 'DELETE', `/invoices/${quoteId}`);
                        responseData = responseData.data;
                    }
                }
