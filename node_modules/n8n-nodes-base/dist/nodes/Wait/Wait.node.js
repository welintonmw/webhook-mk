...
const onFormSubmitProperties = (0, utilities_1.updateDisplayOptions)(displayOnFormSubmission, [
...
const onWebhookCallProperties = (0, utilities_1.updateDisplayOptions)(displayOnWebhook, [
    {
...
class Wait extends Webhook_node_1.Webhook {
        ...
        this.description = {
            ...
            properties: [
                ...
                ...waitTimeProperties,
                {
                    ...
                    displayOptions: displayOnWebhook,
                    options: [...description_1.optionsProperty.options, webhookSuffix],
                },
                {
                    displayName: 'Options',
                    name: 'options',
                    ...
                    options: [common_descriptions_1.respondWithOptions, webhookSuffix],
                },
                {
                    displayName: 'Options',
                    name: 'options',
    ...
    async webhook(context) {
        ...
        if (resume === 'form')
            return await (0, utils_1.formWebhook)(context);
    ...
    async execute(context) {
        ...
        if (resume === 'timeInterval') {
            ...
            const dateTimeStr = context.getNodeParameter('dateTime', 0);
            waitTill = luxon_1.DateTime.fromFormat(dateTimeStr, "yyyy-MM-dd'T'HH:mm:ss", {
