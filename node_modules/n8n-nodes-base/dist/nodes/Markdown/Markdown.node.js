        ...
        for (let i = 0; i < length; i++) {
            try {
                if (mode === 'htmlToMarkdown') {
                    ...
                    const textReplaceOption = this.getNodeParameter('options.textReplace.values', i, []);
                    options.textReplace = !(0, isEmpty_1.default)(textReplaceOption)
                        ? textReplaceOption.map((entry) => [entry.pattern, entry.replacement])
                        : undefined;
                    const lineStartEscapeOption = this.getNodeParameter('options.lineStartEscape.value', i, {});
                    options.lineStartEscape = !(0, isEmpty_1.default)(lineStartEscapeOption)
                        ? [lineStartEscapeOption.pattern, lineStartEscapeOption.replacement]
                        : undefined;
                    const globalEscapeOption = this.getNodeParameter('options.globalEscape.value', i, {});
                    options.globalEscape = !(0, isEmpty_1.default)(globalEscapeOption)
                        ? [globalEscapeOption.pattern, globalEscapeOption.replacement]
                        : undefined;
                    options.ignore = options.ignore
                        ? options.ignore.split(',').map((element) => element.trim())
                        : undefined;
                    options.blockElements = options.blockElements
                        ? options.blockElements.split(',').map((element) => element.trim())
                        : undefined;
                    ...
                    const markdownFromHTML = node_html_markdown_1.NodeHtmlMarkdown.translate(html, markdownOptions);
                    const newItem = (0, n8n_workflow_1.deepCopy)(items[i].json);
                    (0, set_1.default)(newItem, destinationKey, markdownFromHTML);
                ...
                if (mode === 'markdownToHtml') {
                    ...
                    const newItem = (0, n8n_workflow_1.deepCopy)(items[i].json);
                    (0, set_1.default)(newItem, destinationKey, htmlFromMarkdown);
                    returnData.push(newItem);
                }
            }
            catch (error) {
