...
const toDisplayName = ({ name, value }) => {
    return { name: exports.splitPascalCase(name), value };
};
exports.toDisplayName = toDisplayName;
const splitPascalCase = (word) => {
    var _a;
    return (_a = word.match(/($[a-z])|[A-Z][^A-Z]+/g)) === null || _a === void 0 ? void 0 : _a.join(' ');
};
...
function adjustTransactionDates(transactionFields) {
    ...
    let adjusted = lodash_1.omit(transactionFields, dateFieldKeys);
