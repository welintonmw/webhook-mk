...
function populateFields(body, fields, resource) {
    Object.entries(fields).forEach(([key, value]) => {
        if (resource === 'bill') {
            ...
            if (key === 'BillAddr') {
                const { details } = value;
                body.BillAddr = (0, pickBy_1.default)(details, (detail) => detail !== '');
            }
            ...
            if (key === 'BillAddr' || key === 'ShipAddr') {
                const { details } = value;
                body[key] = (0, pickBy_1.default)(details, (detail) => detail !== '');
            }
...
function adjustTransactionDates(transactionFields) {
    ...
    let adjusted = (0, omit_1.default)(transactionFields, dateFieldKeys);
