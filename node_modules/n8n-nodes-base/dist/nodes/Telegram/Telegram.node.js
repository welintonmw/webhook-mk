            ...
            try {
                ...
                if (resource === 'callback') {
                    ...
                    if (operation === 'editMessageText') {
                        ...
                        GenericFunctions_1.addAdditionalFields.call(this, body, i);
                    }
                        ...
                        body.chat_id = this.getNodeParameter('chatId', i);
                        body.text = this.getNodeParameter('text', i);
                        GenericFunctions_1.addAdditionalFields.call(this, body, i, nodeVersion, instanceId);
                    }
                ...
                if (binaryData) {
                    ...
                    const propertyName = (0, GenericFunctions_1.getPropertyName)(operation);
                    const fileName = this.getNodeParameter('additionalFields.fileName', 0, '');
                    const filename = fileName || ((_a = itemBinaryData.fileName) === null || _a === void 0 ? void 0 : _a.toString());
                    if (!fileName && !itemBinaryData.fileName) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `File name is needed to ${operation}. Make sure the property that holds the binary data
						has the file name property set or set it manually in the node using the File Name parameter under
						Additional Fields.`);
                    }
                    body.disable_notification = ((_b = body.disable_notification) === null || _b === void 0 ? void 0 : _b.toString()) || 'false';
                    let uploadData;
                    ...
                    responseData = await GenericFunctions_1.apiRequest.call(this, requestMethod, endpoint, {}, qs, { formData });
                }
                else {
                ...
                if (resource === 'file' && operation === 'get') {
                    ...
                    const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData.result), { itemData: { item: i } });
