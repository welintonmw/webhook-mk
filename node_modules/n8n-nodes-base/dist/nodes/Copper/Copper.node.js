                ...
                if (resource === 'company') {
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustCompanyFields(additionalFields));
                        }
                        ...
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustCompanyFields(updateFields));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustLeadFields(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustLeadFields(updateFields));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPersonFields(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPersonFields(updateFields));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const filterFields = this.getNodeParameter('filterFields', i);
                        if (Object.keys(filterFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustTaskFields(filterFields));
                        }
