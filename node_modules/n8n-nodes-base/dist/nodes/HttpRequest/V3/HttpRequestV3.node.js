        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (responseData.status !== 'fulfilled') {
                ...
                if (!this.continueOnFail()) {
                    ...
                    const error = new n8n_workflow_1.NodeApiError(this.getNode(), responseData, { itemIndex });
            ...
            for (let [index, response] of Object.entries(responses)) {
                if (((_k = response === null || response === void 0 ? void 0 : response.request) === null || _k === void 0 ? void 0 : _k.constructor.name) === 'ClientRequest')
                ...
                const responseContentType = (_l = response.headers['content-type']) !== null && _l !== void 0 ? _l : '';
                ...
                if (responseFormat === 'file') {
                    ...
                    const preparedBinaryData = await this.helpers.prepareBinaryData(binaryData, undefined, responseContentType || undefined);
