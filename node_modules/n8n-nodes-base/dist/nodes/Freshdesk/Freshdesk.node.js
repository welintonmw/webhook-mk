...
var Source;
(function (Source) {
    Source[Source["Email"] = 1] = "Email";
    Source[Source["Portal"] = 2] = "Portal";
    Source[Source["Phone"] = 3] = "Phone";
    Source[Source["Chat"] = 7] = "Chat";
    Source[Source["Mobihelp"] = 8] = "Mobihelp";
    Source[Source["FeedbackWidget"] = 9] = "FeedbackWidget";
    Source[Source["OutboundEmail"] = 10] = "OutboundEmail";
})(Source || (Source = {}));
class Freshdesk {
    constructor() {
        this.description = {
            ...
            try {
                if (resource === 'ticket') {
                    if (operation === 'create') {
                        ...
                        const body = {
                            status: Status[GenericFunctions_1.capitalize(status)],
                            priority: Priority[GenericFunctions_1.capitalize(priority)],
                            source: Source[GenericFunctions_1.capitalize(source)],
                        };
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.status) {
                            body.status = Status[GenericFunctions_1.capitalize(updateFields.status)];
                        }
                        if (updateFields.priority) {
                            body.priority = Priority[GenericFunctions_1.capitalize(updateFields.priority)];
                        }
                        if (updateFields.source) {
                            body.source = Source[GenericFunctions_1.capitalize(updateFields.source)];
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        if (additionalFields.customFields) {
                            const metadata = additionalFields.customFields.customField;
                        ...
                        const qs = this.getNodeParameter('filters', i, {});
                        responseData = await GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/contacts', {}, qs);
                    }
