...
import { IDataObject, ILoadOptionsFunctions, IPollFunctions } from 'n8n-workflow';
import { TDtableMetadataColumns, TDtableViewColumns } from './types';
import { ICtx, IDtableMetadataColumn, IName, IRow, IRowObject } from './Interfaces';
...
export declare const nameOfPredicate: (names: ReadonlyArray<IName>) => (name: string) => IName | undefined;
...
export declare function rowsDeleteInternalColumns(rows: IRow[]): void;
