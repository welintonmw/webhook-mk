        ...
        this.methods = {
            loadOptions: {
                ...
                async getMilestones() {
                    ...
                    return GenericFunctions_1.toOptions(milestones);
                },
                async getPriorities() {
                    const project = this.getCurrentNodeParameter('projectId');
                    const priorities = await GenericFunctions_1.taigaApiRequest.call(this, 'GET', '/priorities', {}, { project });
                    return GenericFunctions_1.toOptions(priorities);
                },
                async getProjects() {
                    ...
                    return GenericFunctions_1.toOptions(projects);
                },
                async getRoles() {
                    const project = this.getCurrentNodeParameter('projectId');
                ...
                async getSeverities() {
                    ...
                    return GenericFunctions_1.toOptions(severities);
                },
                async getTags() {
                    const project = this.getCurrentNodeParameter('projectId');
                ...
                async getTypes() {
                    ...
                    return GenericFunctions_1.toOptions(types);
                },
                async getUsers() {
                    const project = this.getCurrentNodeParameter('projectId');
                ...
                async getIssueStatuses() {
                    ...
                    return GenericFunctions_1.toOptions(statuses);
                },
