                ...
                async checkExists() {
                    ...
                    for (const webhook of responseData) {
                        ...
                        if (webhookDetails.subscription_url === webhookUrl
                            && GenericFunctions_1.idsExist(webhookDetails.object_ids, ids)
    ...
    async webhook() {
        ...
        return new Promise((resolve, reject) => {
            ...
            req.on('end', async () => {
                ...
                const computedSignature = crypto_1.createHmac('sha1', `${credentials.clientId}&${credentials.clientSecret}`).update(data.join('')).digest('base64');
