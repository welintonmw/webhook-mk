            ...
            if (resource === 'customer') {
                if (operation === 'create') {
                    ...
                    if (Object.keys(additionalFields).length) {
                        Object.assign(body, GenericFunctions_1.adjustMetadata(additionalFields));
                    }
                    ...
                    if (returnAll) {
                        responseData = await GenericFunctions_1.woocommerceApiRequestAllItems.call(this, 'GET', '/customers', {}, qs);
                    }
                    else {
                    ...
                    if (Object.keys(updateFields).length) {
                        Object.assign(body, GenericFunctions_1.adjustMetadata(updateFields));
                    }
                    const customerId = this.getNodeParameter('customerId', i);
                    const endpoint = `/customers/${customerId}`;
                ...
                if (operation === 'create') {
                    ...
                    GenericFunctions_1.setFields(additionalFields, body);
                ...
                if (operation === 'update') {
                    ...
                    const updateFields = this.getNodeParameter('updateFields', i);
                    const body = {};
                    GenericFunctions_1.setFields(updateFields, body);
                    const images = this.getNodeParameter('imagesUi', i).imagesValues;
                    if (images) {
                        body.images = images;
                    }
