                ...
                if (resource === 'account') {
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustAccountPayload(additionalFields));
                        }
                        ...
                        GenericFunctions_1.addGetAllFilterOptions(qs, options);
                        ...
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustAccountPayload(updateFields));
                        }
                        else {
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustContactPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustContactPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustDealPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustDealPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const body = {
                            ...
                            Product_Details: GenericFunctions_1.adjustProductDetails(productDetails),
                        };
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustInvoicePayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustInvoicePayloadOnUpdate(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustLeadPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustLeadPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustProductPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustProductPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPurchaseOrderPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPurchaseOrderPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustQuotePayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustQuotePayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustSalesOrderPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustSalesOrderPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustVendorPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustVendorPayload(updateFields));
                        }
                        else {
                            GenericFunctions_1.throwOnEmptyUpdate.call(this, resource);
                        }
