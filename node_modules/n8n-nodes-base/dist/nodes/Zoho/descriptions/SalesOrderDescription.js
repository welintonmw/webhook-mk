...
exports.salesOrderFields = exports.salesOrderOperations = void 0;
const SharedFields_1 = require("./SharedFields");
exports.salesOrderOperations = [
    {
...
exports.salesOrderFields = [
    ...
    },
    {
        ...
        options: [
            ...
            SharedFields_1.makeCustomFieldsFixedCollection('salesOrder'),
            {
                displayName: 'Deal ID',
                name: 'dealId',
                type: 'options',
    ...
    ...SharedFields_1.makeGetAllFields('salesOrder'),
    {
        displayName: 'Sales Order ID',
        name: 'salesOrderId',
