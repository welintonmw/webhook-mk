...
exports.currencies = exports.makeCustomFieldsFixedCollection = exports.makeGetAllFields = exports.productDetailsOptions = exports.address = exports.otherAddress = exports.mailingAddress = exports.shippingAddress = exports.billingAddress = void 0;
...
const makeGetAllFields = (resource) => {
    const loadOptionsMethod = `get${GenericFunctions_1.capitalizeInitial(resource)}Fields`;
    return [
        {
...
exports.makeGetAllFields = makeGetAllFields;
const makeCustomFieldsFixedCollection = (resource) => {
    const loadOptionsMethod = `getCustom${GenericFunctions_1.capitalizeInitial(resource)}Fields`;
    return {
...
exports.makeCustomFieldsFixedCollection = makeCustomFieldsFixedCollection;
exports.currencies = [
