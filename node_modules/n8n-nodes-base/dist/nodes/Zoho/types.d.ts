...
export type LocationType = 'Address' | 'Billing_Address' | 'Mailing_Address' | 'Shipping_Address' | 'Other_Address';
export type DateType = 'Date_of_Birth' | 'Closing_Date' | 'Due_Date' | 'Invoice_Date' | 'PO_Date' | 'Valid_Till';
export type AllFields = {
    [Date in DateType]?: string;
} & {
    [Location in LocationType]?: {
        address_fields: {
            [key: string]: string;
        };
    };
...
export type ResourceItems = Array<{
    [key: string]: string;
}>;
