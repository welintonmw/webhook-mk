            ...
            try {
                if (resource === 'contact') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.driftApiRequest.call(this, 'POST', '/contacts', { attributes: body });
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.driftApiRequest.call(this, 'PATCH', `/contacts/${contactId}`, { attributes: body });
                        responseData = responseData.data;
                    }
                    if (operation === 'get') {
                        const contactId = this.getNodeParameter('contactId', i);
