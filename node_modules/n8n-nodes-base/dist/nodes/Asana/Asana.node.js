        ...
        this.methods = {
            loadOptions: {
                ...
                async getProjects() {
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', endpoint, {});
                ...
                async getTeams() {
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequestAllItems.call(this, 'GET', endpoint, {});
                    const returnData = [];
                ...
                async getTags() {
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', endpoint, {}, { workspace });
                    if (responseData.data === undefined) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, { message: 'No data got returned' });
                    }
                    const returnData = [];
                ...
                async getTaskFields() {
                    const returnData = [];
                    for (const field of GenericFunctions_1.getTaskFields()) {
                        const value = change_case_1.snakeCase(field);
                        returnData.push({
                            name: field,
                            value: (value === '') ? '*' : value,
                        });
            ...
            try {
                ...
                if (resource === 'subtask') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, requestMethod, endpoint, body, qs);
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (qs.opt_fields) {
                            ...
                            if (fields.includes('*')) {
                                qs.opt_fields = GenericFunctions_1.getTaskFields().map((e) => change_case_1.snakeCase(e)).join(',');
                            }
                            else {
                ...
                if (resource === 'task') {
                    if (operation === 'create') {
                        ...
                        if (qs.modified_since) {
                            qs.modified_since = moment.tz(qs.modified_since, timezone).format();
                        }
                        if (qs.completed_since) {
                            qs.completed_since = moment.tz(qs.completed_since, timezone).format();
                        }
                        if (returnAll) {
                            responseData = await GenericFunctions_1.asanaApiRequestAllItems.call(this, requestMethod, endpoint, body, qs);
                        }
                        else {
