    ...
    constructor() {
        this.description = {
            ...
            properties: [
                    ...
                    options: [
                        {
                            ...
                            description: 'Defines fields to return. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                        {
                            displayName: 'Pretty',
                            name: 'opt_pretty',
                ...
                },
                {
                    ...
                    description: 'The workspace to create the task in. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Name',
                    name: 'name',
                    ...
                    options: [
                        {
                            ...
                            default: '',
                            description: 'The assignee to filter tasks on. Note: If you specify assignee, you must also specify the workspace to filter on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                        {
                            displayName: 'Field Names or IDs',
                            name: 'opt_fields',
                        ...
                        },
                        {
                            ...
                            default: '',
                            description: 'The project to filter tasks on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                        {
                            ...
                            default: '',
                            description: 'The section to filter tasks on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                        {
                            displayName: 'Workspace Name or ID',
                            name: 'workspace',
                            ...
                            default: '',
                            description: 'The workspace to filter tasks on. Note: If you specify workspace, you must also specify the assignee to filter on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                        {
                ...
                },
                {
                    ...
                    description: 'Project to show the sections of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Section Name or ID',
                    name: 'section',
                ...
                },
                {
                    ...
                    description: 'The workspace in which the task is searched. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Filters',
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            default: [],
                            description: 'The project to filter tasks on. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    description: 'The project where the task will be added. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Additional Fields',
                    name: 'additionalFields',
                ...
                },
                {
                    ...
                    description: 'The project where the task will be removed from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Operation',
                    name: 'operation',
                ...
                },
                {
                    ...
                    description: 'The tag that should be added. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Task ID',
                    name: 'id',
                ...
                },
                {
                    ...
                    description: 'The workspace in which to get users. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Operation',
                    name: 'operation',
                ...
                },
                {
                    ...
                    description: 'The workspace to create the project in. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    ...
                    default: '',
                    description: 'The team this project will be assigned to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
                {
                    displayName: 'Additional Fields',
                    name: 'additionalFields',
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            default: '',
                            description: 'The new name of the task. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                        },
                    ],
                },
                {
        ...
        this.methods = {
            loadOptions: {
                ...
                async getProjects() {
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', '/projects', {});
                ...
                async getSections() {
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/projects/${projectId}/sections`, {});
                    if (responseData.data === undefined) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, {
                            message: 'No data got returned',
                        });
                ...
                async getTeams() {
                    ...
                    const workspace = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/workspaces/${workspaceId}`, {});
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequestAllItems.call(this, 'GET', `/organizations/${workspaceId}/teams`, {});
                    const returnData = [];
                ...
                async getTags() {
                    ...
                    let taskData;
                    try {
                        taskData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/tasks/${taskId}`, {});
                    }
                    catch (error) {
                    ...
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', '/tags', {}, { workspace });
                    if (responseData.data === undefined) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, {
                            message: 'No data got returned',
                        });
                ...
                async getUsers() {
                    const responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', '/users', {});
                    if (responseData.data === undefined) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, {
                            message: 'No data got returned',
                        });
            ...
            try {
                ...
                if (resource === 'subtask') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/subtasks`, body, qs);
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (qs.opt_fields) {
                            ...
                            if (fields.includes('*')) {
                                qs.opt_fields = (0, GenericFunctions_1.getTaskFields)()
                                    .map((e) => (0, change_case_1.snakeCase)(e))
                                    .join(',');
                            }
                            else {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/tasks/${taskId}/subtasks`, body, qs);
                        responseData = responseData.data;
                        if (!returnAll) {
                ...
                if (resource === 'task') {
                    if (operation === 'create') {
                        ...
                        const otherProperties = this.getNodeParameter('otherProperties', i);
                        Object.assign(body, otherProperties);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', '/tasks', body, qs);
                        responseData = responseData.data;
                    }
                    else if (operation === 'delete') {
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'DELETE', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                    else if (operation === 'get') {
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.asanaApiRequestAllItems.call(this, 'GET', '/tasks', body, qs);
                        }
                        else {
                            qs.limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', '/tasks', body, qs);
                            responseData = responseData.data;
                        }
                    }
                        ...
                        Object.assign(body);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/sections/${sectionId}/addTask`, body, qs);
                        responseData = { success: true };
                    }
                    else if (operation === 'update') {
                        const otherProperties = this.getNodeParameter('otherProperties', i);
                        Object.assign(body, otherProperties);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'PUT', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/workspaces/${workspaceId}/tasks/search`, body, qs);
                        responseData = responseData.data;
                    }
                }
                if (resource === 'taskComment') {
                    if (operation === 'add') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/stories`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'remove') {
                        const commentId = this.getNodeParameter('id', i);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'DELETE', `/stories/${commentId}`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'taskTag') {
                    if (operation === 'add') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/addTag`, body, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'remove') {
                        const taskId = this.getNodeParameter('id', i);
                        body.tag = this.getNodeParameter('tag', i);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/removeTag`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'taskProject') {
                    if (operation === 'add') {
                        ...
                        Object.assign(body, additionalFields);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/addProject`, body, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'remove') {
                        const taskId = this.getNodeParameter('id', i);
                        body.project = this.getNodeParameter('project', i);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/removeProject`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'user') {
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/users/${userId}`, body, qs);
                        responseData = responseData.data;
                    }
                    else if (operation === 'getAll') {
                        const workspaceId = this.getNodeParameter('workspace', i);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/workspaces/${workspaceId}/users`, body, qs);
                        responseData = responseData.data;
                    }
                }
                if (resource === 'project') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'POST', `/teams/${teamId}/projects`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'delete') {
                        const projectId = this.getNodeParameter('id', i);
                        await GenericFunctions_1.asanaApiRequest.call(this, 'DELETE', `/projects/${projectId}`, body, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'get') {
                        const projectId = this.getNodeParameter('id', i);
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', `/projects/${projectId}`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'getAll') {
                        const workspaceId = this.getNodeParameter('workspace', i);
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.asanaApiRequestAllItems.call(this, 'GET', '/projects', body, qs);
                        }
                        else {
                            qs.limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'GET', '/projects', body, qs);
                            responseData = responseData.data;
                        }
                    }
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.asanaApiRequest.call(this, 'PUT', `/projects/${projectId}`, body, qs);
                        responseData = responseData.data;
                    }
                }
