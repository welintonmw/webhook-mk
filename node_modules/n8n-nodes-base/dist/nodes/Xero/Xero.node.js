        ...
        this.methods = {
            loadOptions: {
                async getItemCodes() {
                    ...
                    const returnData = [];
                    const { Items: items } = await GenericFunctions_1.xeroApiRequest.call(this, 'GET', '/items', { organizationId });
                ...
                async getCurrencies() {
                    const organizationId = this.getCurrentNodeParameter('organizationId');
                    const returnData = [];
                    const { Currencies: currencies } = await GenericFunctions_1.xeroApiRequest.call(this, 'GET', '/Currencies', { organizationId });
            ...
            try {
                ...
                if (resource === 'invoice') {
                    ...
                    if (operation === 'get') {
                        const organizationId = this.getNodeParameter('organizationId', i);
                        const invoiceId = this.getNodeParameter('invoiceId', i);
                        responseData = await GenericFunctions_1.xeroApiRequest.call(this, 'GET', `/Invoices/${invoiceId}`, { organizationId });
                        responseData = responseData.Invoices;
                    }
                    if (operation === 'getAll') {
                        const organizationId = this.getNodeParameter('organizationId', i);
                ...
                if (resource === 'contact') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.xeroApiRequest.call(this, 'POST', '/Contacts', { organizationId, Contacts: [body] });
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.xeroApiRequest.call(this, 'POST', `/Contacts/${contactId}`, { organizationId, Contacts: [body] });
                        responseData = responseData.Contacts;
                    }
                }
