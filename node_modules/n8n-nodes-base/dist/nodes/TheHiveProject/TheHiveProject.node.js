...
class TheHiveProject {
    constructor() {
        this.description = node_description_1.description;
        this.methods = { loadOptions: methods_1.loadOptions, listSearch: methods_1.listSearch, resourceMapping: methods_1.resourceMapping };
    }
    async execute() {
