        ...
        this.methods = {
            ...
            credentialTest: {
                async gristApiTest(credential) {
                    const { apiKey, planType, customSubdomain, } = credential.data;
            ...
            try {
                if (operation === 'create') {
                    ...
                    if (dataToSend === 'autoMapInputs') {
                        ...
                        const fields = GenericFunctions_1.parseAutoMappedInputs(incomingKeys, inputsToIgnore, items[i].json);
                        ...
                        body.records.push({ fields: GenericFunctions_1.parseDefinedFields(properties) });
                    }
                    const docId = this.getNodeParameter('docId', 0);
                    const tableId = this.getNodeParameter('tableId', 0);
                    ...
                    if (dataToSend === 'autoMapInputs') {
                        ...
                        const { properties } = this.getNodeParameter('fieldsToSend', i, []);
                        GenericFunctions_1.throwOnZeroDefinedFields.call(this, properties);
                        const fields = GenericFunctions_1.parseDefinedFields(properties);
                        body.records.push({ id: Number(rowId), fields });
                    }
                    const docId = this.getNodeParameter('docId', 0);
                    const tableId = this.getNodeParameter('tableId', 0);
                    ...
                    if (sort === null || sort === void 0 ? void 0 : sort.sortProperties.length) {
                        qs.sort = GenericFunctions_1.parseSortProperties(sort.sortProperties);
                    }
                    if (filter === null || filter === void 0 ? void 0 : filter.filterProperties.length) {
                        const parsed = GenericFunctions_1.parseFilterProperties(filter.filterProperties);
