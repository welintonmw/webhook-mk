...
class Slack {
    constructor() {
        ...
        this.methods = {
            ...
            credentialTest: {
                async testSlackTokenAuth(credential) {
                    const options = {
                        method: 'POST',
                        headers: {
                ...
                if (resource === 'message') {
                    if (['post', 'postEphemeral'].includes(operation)) {
                        ...
                        if (!jsonParameters) {
                                ...
                                for (const blockUi of blocksUi) {
                                    ...
                                    if (block.type === 'actions') {
                                        ...
                                        if (textUi) {
                                            ...
                                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Property text must be defined');
                                        }
                            ...
                            if (attachmentsJson !== '' && GenericFunctions_1.validateJSON(attachmentsJson) === undefined) {
                                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Attachments it is not a valid json');
                            }
                            if (blocksJson !== '' && GenericFunctions_1.validateJSON(blocksJson) === undefined) {
                ...
                if (resource === 'file') {
                    if (operation === 'upload') {
                        ...
                        if (binaryData) {
                            ...
                            body.file = {
                                value: Buffer.from(items[i].binary[binaryPropertyName].data, n8n_core_1.BINARY_ENCODING),
                                options: {
