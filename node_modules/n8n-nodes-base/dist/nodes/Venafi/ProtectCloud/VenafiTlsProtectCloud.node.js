                ...
                if (resource === 'certificate') {
                    ...
                    if (operation === 'download') {
                        ...
                        if (downloadItem === 'certificate') {
                            ...
                            responseData = await GenericFunctions_1.venafiApiRequest.call(this, 'GET', `/outagedetection/v1/certificates/${certificateId}/contents`, {}, qs, { encoding: null, json: false, resolveWithFullResponse: true, cert: true });
                        }
                        else {
                            ...
                            responseData = await GenericFunctions_1.venafiApiRequest.call(this, 'POST', `/outagedetection/v1/certificates/${certificateId}/keystore`, body, {}, { encoding: null, json: false, resolveWithFullResponse: true });
                        }
