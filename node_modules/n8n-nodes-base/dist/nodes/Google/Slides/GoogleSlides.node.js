        ...
        this.methods = {
            loadOptions: {
                async getPages() {
                    ...
                    const { slides } = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`, {}, { fields: 'slides' });
            ...
            try {
                if (resource === 'page') {
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}/pages/${pageObjectId}`);
                        ...
                        const presentationId = this.getNodeParameter('presentationId', i);
                        const pageObjectId = this.getNodeParameter('pageObjectId', i);
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}/pages/${pageObjectId}/thumbnail`);
                    ...
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', '/presentations', body);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'get') {
                        const presentationId = this.getNodeParameter('presentationId', i);
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                        ...
                        const presentationId = this.getNodeParameter('presentationId', i);
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`, {}, { fields: 'slides' });
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `/presentations/${presentationId}:batchUpdate`, { requests });
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                }
