            ...
            try {
                if (resource === 'volume') {
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `v1/volumes/${volumeId}`, {});
                    }
                    else if (operation === 'getAll') {
                        const searchQuery = this.getNodeParameter('searchQuery', i);
                        const returnAll = this.getNodeParameter('returnAll', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_1.googleApiRequestAllItems.call(this, 'items', 'GET', `v1/volumes?q=${searchQuery}`, {});
                        }
                        else {
                            qs.maxResults = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `v1/volumes?q=${searchQuery}`, {}, qs);
                ...
                if (resource === 'bookshelf') {
                    if (operation === 'get') {
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.googleApiRequestAllItems.call(this, 'items', 'GET', endpoint, {});
                        }
                        else {
                            qs.maxResults = this.getNodeParameter('limit', i);
                ...
                if (resource === 'bookshelfVolume') {
                    if (operation === 'add') {
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `v1/mylibrary/bookshelves/${shelfId}/addVolume`, body);
                    }
                    if (operation === 'clear') {
                        const shelfId = this.getNodeParameter('shelfId', i);
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `v1/mylibrary/bookshelves/${shelfId}/clearVolumes`);
                    }
                    if (operation === 'getAll') {
                        const shelfId = this.getNodeParameter('shelfId', i);
                        const returnAll = this.getNodeParameter('returnAll', i);
                    ...
                    if (operation === 'move') {
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `v1/mylibrary/bookshelves/${shelfId}/moveVolume`, body);
                    }
                    if (operation === 'remove') {
                        const shelfId = this.getNodeParameter('shelfId', i);
                        const volumeId = this.getNodeParameter('volumeId', i);
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `v1/mylibrary/bookshelves/${shelfId}/removeVolume`, body);
                    }
                }
...
//# sourceMappingURL=GoogleBooks.node.js.map