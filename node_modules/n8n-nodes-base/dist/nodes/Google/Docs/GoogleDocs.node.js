            ...
            try {
                if (resource === 'document') {
                    if (operation === 'create') {
                        ...
                        let documentId = GenericFunctions_1.extractID(documentURL);
                        if (!documentId) {
                        ...
                        if (GenericFunctions_1.hasKeys(writeControlObject)) {
                        ...
                        if (actionsUi) {
                            ...
                            actionsUi.actionFields.forEach(actionField => {
                                ...
                                body.requests.push({
                                    [`${action}${GenericFunctions_1.upperFirst(object)}`]: requestBody,
                                });
                            });
                        }
