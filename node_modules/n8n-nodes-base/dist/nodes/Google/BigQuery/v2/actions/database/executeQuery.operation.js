...
async function execute() {
    ...
    for (let i = 0; i < length; i++) {
        try {
            ...
            for (const resolvable of (0, utilities_1.getResolvables)(sqlQuery)) {
            ...
            if (((_c = response.status) === null || _c === void 0 ? void 0 : _c.state) === 'DONE') {
                ...
                returnData.push(...utils_1.prepareOutput.call(this, queryResponse, i, raw, includeSchema));
            }
            else {
        ...
        for (const job of jobs) {
            try {
                ...
                if (response.jobComplete) {
                    ...
                    returnData.push(...utils_1.prepareOutput.call(this, response, job.i, job.raw, job.includeSchema));
                }
                if ((_d = response === null || response === void 0 ? void 0 : response.errors) === null || _d === void 0 ? void 0 : _d.length) {
                    ...
                    throw new n8n_workflow_1.ApplicationError(`Error(s) ocurring while executing query from item ${job.i.toString()}: ${errorMessages.join(', ')}`, { level: 'warning' });
                }
            }
            catch (error) {
                if (this.continueOnFail(error)) {
