...
class GoogleDriveTrigger {
    constructor() {
        ...
        this.methods = {
            listSearch: {
                fileSearch: listSearch_1.fileSearch,
                folderSearch: listSearch_1.folderSearch,
            },
            loadOptions: {
                async getDrives() {
                    const returnData = [];
                    const drives = await GenericFunctions_1.googleApiRequestAllItems.call(this, 'drives', 'GET', '/drive/v3/drives');
                    returnData.push({
                        name: 'Root',
                        value: 'root',
                    });
    ...
    async poll() {
        ...
        if (triggerOn === 'specificFolder' && event !== 'watchFolderUpdated') {
            const folderToWatch = (0, GenericFunctions_1.extractId)(this.getNodeParameter('folderToWatch', '', { extractValue: true }));
        ...
        if (this.getMode() === 'manual') {
            qs.pageSize = 1;
            files = await GenericFunctions_1.googleApiRequest.call(this, 'GET', '/drive/v3/files', {}, qs);
            files = files.files;
        }
        else {
            files = await GenericFunctions_1.googleApiRequestAllItems.call(this, 'files', 'GET', '/drive/v3/files', {}, qs);
        }
        if (triggerOn === 'specificFile' && this.getMode() !== 'manual') {
            const fileToWatch = (0, GenericFunctions_1.extractId)(this.getNodeParameter('fileToWatch', '', { extractValue: true }));
