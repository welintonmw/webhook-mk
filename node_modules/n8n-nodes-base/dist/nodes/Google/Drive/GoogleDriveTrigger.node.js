...
class GoogleDriveTrigger {
    ...
    async poll() {
        ...
        if (triggerOn === 'specificFolder' && event !== 'watchFolderUpdated') {
            const folderToWatch = GenericFunctions_1.extractId(this.getNodeParameter('folderToWatch'));
        ...
        if (triggerOn === 'specificFile' && this.getMode() !== 'manual') {
            const fileToWatch = GenericFunctions_1.extractId(this.getNodeParameter('fileToWatch'));
