    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                options: common_descriptions_1.fileTypesOptions,
                displayOptions: {
                    show: {
                        whatToSearch: ['all'],
                    },
            ...
            },
            {
                ...
                default: [],
                description: 'Return only items corresponding to the selected MIME types',
                options: common_descriptions_1.fileTypesOptions.filter((option) => option.name !== 'Folder'),
                displayOptions: {
                    show: {
                        whatToSearch: ['files'],
                    },
...
async function execute(i) {
    ...
    if ((_a = Object.keys(filter)) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        if (folderId && folderId !== interfaces_1.RLC_FOLDER_DEFAULT) {
        ...
        if (whatToSearch === 'folders') {
            ...
            if (((_b = filter === null || filter === void 0 ? void 0 : filter.fileTypes) === null || _b === void 0 ? void 0 : _b.length) && !filter.fileTypes.includes('*')) {
    ...
    (0, utils_1.updateDriveScopes)(qs, driveId);
    if (!driveId && folderId === interfaces_1.RLC_FOLDER_DEFAULT) {
        qs.corpora = 'user';
        qs.spaces = 'drive';
    ...
    let response;
    if (returnAll) {
        response = await transport_1.googleApiRequestAllItems.call(this, 'GET', 'files', '/drive/v3/files', {}, qs);
    }
    else {
        qs.pageSize = this.getNodeParameter('limit', i);
        response = await transport_1.googleApiRequest.call(this, 'GET', '/drive/v3/files', undefined, qs);
