            ...
            try {
                ...
                if (resource === 'event') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (options.timeMax) {
                            qs.timeMax = (0, GenericFunctions_1.addTimezoneToDate)(options.timeMax, tz || timezone);
                        }
                        if (options.timeMin) {
                            qs.timeMin = (0, GenericFunctions_1.addTimezoneToDate)(options.timeMin, tz || timezone);
                        }
                        if (tz) {
                            qs.timeZone = tz;
                        }
                        if (options.updatedMin) {
                            qs.updatedMin = (0, GenericFunctions_1.addTimezoneToDate)(options.updatedMin, tz || timezone);
                        }
                        if (returnAll) {
