            ...
            if (operation === 'get') {
                ...
                for (let i = 0; i < itemsLength; i++) {
                    try {
                        ...
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: fallbackPairedItems !== null && fallbackPairedItems !== void 0 ? fallbackPairedItems : [{ item: i }] });
                        returnData.push(...executionData);
                    }
                    catch (error) {
