            ...
            try {
                if (resource === 'channel') {
                    ...
                    if (operation === 'uploadBanner') {
                        ...
                        const body = Buffer.from(item.binary[binaryProperty].data, n8n_core_1.BINARY_ENCODING);
                ...
                if (resource === 'video') {
                    ...
                    if (operation === 'upload') {
                        ...
                        const response = await GenericFunctions_1.googleApiRequest.call(this, 'POST', '/upload/youtube/v3/videos', body, qs, undefined, requestOptions);
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'PUT', `/youtube/v3/videos`, data, qs);
                    }
                    if (operation === 'update') {
