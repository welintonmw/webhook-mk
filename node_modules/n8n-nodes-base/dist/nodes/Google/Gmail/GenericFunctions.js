...
exports.simplifyOutput = exports.replyToEmail = exports.unescapeSnippets = exports.prepareEmailAttachments = exports.prepareEmailBody = exports.prepareEmailsInput = exports.prepareQuery = exports.prepareTimestamp = exports.extractEmail = exports.googleApiRequestAllItems = exports.encodeEmail = exports.parseRawEmail = exports.googleApiRequest = void 0;
...
async function googleApiRequest(method, endpoint, body = {}, qs = {}, uri, option = {}) {
    ...
    try {
        ...
        if (authentication === 'serviceAccount') {
            ...
            const { access_token } = await GenericFunctions_1.getGoogleAccessToken.call(this, credentials, 'gmail');
...
function prepareEmailBody(itemIndex, appendAttribution = false, instanceId) {
    ...
    if (appendAttribution) {
        ...
        const link = `https://n8n.io/?utm_source=n8n-internal&utm_medium=powered_by&utm_campaign=${encodeURIComponent('n8n-nodes-base.gmail')}${instanceId ? '_' + instanceId : ''}`;
        if (emailType === 'html') {
            message = `
			${message}
			<br>
...
async function prepareEmailAttachments(options, itemIndex) {
    ...
    if (attachments && !(0, isEmpty_1.default)(attachments)) {
