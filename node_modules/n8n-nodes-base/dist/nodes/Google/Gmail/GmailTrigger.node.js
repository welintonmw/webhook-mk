    ...
    async poll() {
        ...
        if (node.typeVersion > 1) {
            ...
            if (workflowStaticData[nodeName] === undefined) {
                workflowStaticData[nodeName] = {};
                nodeStaticData = workflowStaticData[nodeName];
            }
            else {
                nodeStaticData = workflowStaticData[nodeName];
            }
        ...
        const getEmailDateAsSeconds = (email) => {
            ...
            if (email.internalDate) {
                ...
                date = +luxon_1.DateTime.fromJSDate(new Date((_a = email === null || email === void 0 ? void 0 : email.headers) === null || _a === void 0 ? void 0 : _a.date)).toSeconds();
            }
            if (!date || isNaN(date)) {
        ...
        const possibleDuplicates = nodeStaticData.possibleDuplicates || [];
