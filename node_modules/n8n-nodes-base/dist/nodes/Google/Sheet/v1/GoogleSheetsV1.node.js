        ...
        this.methods = {
            ...
            credentialTest: {
                async googleApiCredentialTest(credential) {
                    try {
                        const tokenRequest = await GenericFunctions_1.getGoogleAccessToken.call(this, credential.data, 'sheetV1');
                ...
                for (let i = 0; i < this.getInputData().length; i++) {
                    try {
                        ...
                        if (iterationOptions.tabColor) {
                            const { red, green, blue } = (0, GenericFunctions_2.hexToRgb)(iterationOptions.tabColor);
                        ...
                        responseData = await GenericFunctions_2.googleApiRequest.call(this, 'POST', `/v4/spreadsheets/${sheetId}:batchUpdate`, { requests });
                        if (simple) {
            ...
            if (operation === 'create') {
                for (let i = 0; i < this.getInputData().length; i++) {
                    try {
                        ...
                        responseData = await GenericFunctions_2.googleApiRequest.call(this, 'POST', '/v4/spreadsheets', body);
                        returnData.push(responseData);
                    }
                    catch (error) {
                        if (this.continueOnFail(error)) {
