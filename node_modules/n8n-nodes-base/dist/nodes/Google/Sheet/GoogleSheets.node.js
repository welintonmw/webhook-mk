            ...
            if (operation === 'append') {
                ...
                for (let i = 0; i < this.getInputData().length; i++) {
                    try {
                        ...
                        if (options.tabColor) {
                            const { red, green, blue } = GenericFunctions_1.hexToRgb(options.tabColor);
                        ...
                        responseData = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `/v4/spreadsheets/${spreadsheetId}:batchUpdate`, { requests });
                        if (simple === true) {
