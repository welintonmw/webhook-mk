...
class GoogleSheet {
    ...
    prepareDataForUpdatingByRowNumber(inputData, range, columnNamesList) {
        ...
        for (const item of inputData) {
            ...
            for (const name of columnNames) {
                ...
                if (item[name] === undefined || item[name] === null)
                    continue;
                const columnToUpdate = this.getColumnWithOffset(((_a = decodedRange.start) === null || _a === void 0 ? void 0 : _a.column) || 'A', columnNames.indexOf(name));
                let updateValue = item[name];
                if (typeof updateValue === 'object') {
                    try {
                        updateValue = JSON.stringify(updateValue);
    ...
    async lookupValues(inputData, keyRowIndex, dataStartRowIndex, lookupValues, returnAllMatches, combineFilters = 'OR') {
        var _a, _b;
        const keys = [];
        ...
        if (combineFilters === 'OR') {
            lookupLoop: for (const lookupValue of lookupValues) {
                ...
                for (rowIndex = dataStartRowIndex; rowIndex < inputData.length; rowIndex++) {
                    if (((_a = inputData[rowIndex][returnColumnIndex]) === null || _a === void 0 ? void 0 : _a.toString()) ===
            ...
            lookupLoop: for (rowIndex = dataStartRowIndex; rowIndex < inputData.length; rowIndex++) {
                ...
                for (const lookupValue of lookupValues) {
                    ...
                    if (((_b = inputData[rowIndex][returnColumnIndex]) === null || _b === void 0 ? void 0 : _b.toString()) !==
                        lookupValue.lookupValue.toString()) {
                        allMatch = false;
                        break;
                    }
