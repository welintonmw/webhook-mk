...
class GoogleSheet {
    ...
    async appendSheetData(inputData, range, keyRowIndex, valueInputMode) {
    ...
    async updateSheetData(inputData, indexKey, range, keyRowIndex, dataStartRowIndex, valueInputMode, valueRenderMode) {
    ...
    async convertStructuredDataToArray(inputData, range, keyRowIndex) {
