        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    const webhooks = await GenericFunctions_1.boxApiRequestAllItems.call(this, 'entries', 'GET', endpoint, {});
                ...
                async create() {
                    ...
                    const responseData = await GenericFunctions_1.boxApiRequest.call(this, 'POST', endpoint, body);
                ...
                async delete() {
                    ...
                    if (webhookData.webhookId !== undefined) {
                        ...
                        try {
                            await GenericFunctions_1.boxApiRequest.call(this, 'DELETE', endpoint);
                        }
                        catch (error) {
                            return false;
                        }
