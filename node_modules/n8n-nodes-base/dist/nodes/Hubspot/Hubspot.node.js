        ...
        this.methods = {
            loadOptions: {
                ...
                async getTicketStages() {
                    const currentPipelineId = this.getCurrentNodeParameter('pipelineId');
                    const returnData = [];
                    const endpoint = '/crm-pipelines/v1/pipelines/tickets';
                    const { results } = await GenericFunctions_1.hubspotApiRequest.call(this, 'GET', endpoint, {});
                    for (const pipeline of results) {
                ...
                try {
                    if (resource === 'contact') {
                        if (operation === 'upsert') {
                            ...
                            responseData = await GenericFunctions_1.hubspotApiRequest.call(this, 'POST', endpoint, { properties: body });
                        ...
                        if (operation === 'get') {
                            ...
                            if (additionalFields.propertyMode) {
                                qs.propertyMode = change_case_1.snakeCase(additionalFields.propertyMode);
                            }
                        ...
                        if (operation === 'getRecentlyCreatedUpdated') {
                            ...
                            if (filters.propertyMode) {
                                qs.propertyMode = change_case_1.snakeCase(filters.propertyMode);
                            }
                    ...
                    if (resource === 'company') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = await GenericFunctions_1.hubspotApiRequest.call(this, 'PUT', endpoint, { properties: body });
                        }
                        if (operation === 'get') {
                            const companyId = this.getNodeParameter('companyId', i);
                            const additionalFields = this.getNodeParameter('additionalFields', i);
                    ...
                    if (resource === 'form') {
                        ...
                        if (operation === 'submit') {
                            ...
                            if (context) {
                                GenericFunctions_1.clean(context);
