...
exports.validateCredentials = exports.getAssociations = exports.getCallMetadata = exports.getMeetingMetadata = exports.getTaskMetadata = exports.getEmailMetadata = exports.dealFields = exports.companyFields = exports.contactFields = exports.propertyEvents = exports.clean = exports.validateJSON = exports.hubspotApiRequestAllItems = exports.hubspotApiRequest = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const moment_timezone_1 = __importDefault(require("moment-timezone"));
async function hubspotApiRequest(method, endpoint, body = {}, query = {}, uri) {
...
exports.hubspotApiRequest = hubspotApiRequest;
async function hubspotApiRequestAllItems(_propertyName, method, endpoint, body = {}, query = {}) {
    const returnData = [];
    let responseData;
...
exports.hubspotApiRequestAllItems = hubspotApiRequestAllItems;
...
const reduceMetadatFields = (data) => {
    return data
        .reduce((a, v) => {
        a.push(...v.split(','));
        return a;
...
const getEmailMetadata = (meta) => {
    return {
        ...
        cc: reduceMetadatFields(meta.cc || []),
        bcc: reduceMetadatFields(meta.bcc || []),
...
const getMeetingMetadata = (meta) => {
    return {
        ...(meta.body && { body: meta.body }),
        ...(meta.startTime && { startTime: (0, moment_timezone_1.default)(meta.startTime).unix() }),
        ...(meta.endTime && { endTime: (0, moment_timezone_1.default)(meta.endTime).unix() }),
        ...(meta.title && { title: meta.title }),
        ...(meta.internalMeetingNotes && { internalMeetingNotes: meta.internalMeetingNotes }),
    };
};
exports.getMeetingMetadata = getMeetingMetadata;
const getCallMetadata = (meta) => {
    return {
...
exports.getCallMetadata = getCallMetadata;
...
async function validateCredentials(decryptedCredentials) {
    ...
    const { apiKey, appToken } = credentials;
    const options = {
        method: 'GET',
        headers: {},
