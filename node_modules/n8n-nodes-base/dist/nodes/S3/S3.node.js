            ...
            try {
                ...
                if (resource === 'bucket') {
                    ...
                    if (operation === 'search') {
                        ...
                        qs['list-type'] = 2;
                        responseData = await GenericFunctions_1.s3ApiRequestSOAP.call(this, bucketName, 'GET', '', '', { location: '' });
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'download') {
                        ...
                        let region = await GenericFunctions_1.s3ApiRequestSOAP.call(this, bucketName, 'GET', '', '', { location: '' });
