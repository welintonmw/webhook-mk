        ...
        for (let i = 0; i < items.length; i++) {
            try {
                if (resource === 'message') {
                    ...
                    const toEmailArray = GenericFunctions_1.getToEmailArray(toEmail);
                    const message = {
                    ...
                    if (options.googleAnalyticsDomains) {
                        message.google_analytics_domains = GenericFunctions_1.getGoogleAnalyticsDomainsArray(options.googleAnalyticsDomains);
                    }
                    if (options.tags) {
                        message.tags = GenericFunctions_1.getTags(options.tags);
                    }
                    if (options.fromName) {
                    ...
                    if (jsonActive) {
                        body.message.headers = GenericFunctions_1.validateJSON(this.getNodeParameter('headersJson', i));
                        body.message.metadata = GenericFunctions_1.validateJSON(this.getNodeParameter('metadataJson', i));
                        body.message.global_merge_vars = GenericFunctions_1.validateJSON(this.getNodeParameter('mergeVarsJson', i));
                        body.message.attachments = GenericFunctions_1.validateJSON(this.getNodeParameter('attachmentsJson', i));
                    }
                    else {
