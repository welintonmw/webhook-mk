        ...
        this.methods = {
            loadOptions: {
                async getTemplates() {
                    ...
                    let templates;
                    try {
                        templates = await GenericFunctions_1.mandrillApiRequest.call(this, '/templates', 'POST', '/list');
                    }
                    catch (error) {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                if (resource === 'message') {
                    ...
                    if (options.sendAt) {
                        body.send_at = (0, moment_timezone_1.default)(options.sendAt).utc().format('YYYY-MM-DD HH:mm:ss');
                    }
                    if (jsonActive) {
                        ...
                        if (!(0, isEmpty_1.default)(headersUi)) {
                            body.message.headers = (0, map_1.default)(headersUi.headersValues, (o) => {
                                const aux = {};
                                aux[o.name] = o.value;
                                return aux;
                            });
                        ...
                        if (!(0, isEmpty_1.default)(metadataUi)) {
                            body.message.metadata = (0, map_1.default)(metadataUi.metadataValues, (o) => {
                                const aux = {};
                                aux[o.name] = o.value;
                                return aux;
                            });
                        ...
                        if (!(0, isEmpty_1.default)(mergeVarsUi)) {
                            body.message.global_merge_vars = (0, map_1.default)(mergeVarsUi.mergeVarsValues, (o) => {
                                const aux = {};
                                aux.name = o.name;
                        ...
                        if (!(0, isEmpty_1.default)(attachmentsUi)) {
                            if (attachmentsUi.hasOwnProperty('attachmentsValues') &&
                                !(0, isEmpty_1.default)(attachmentsUi.attachmentsValues)) {
                                attachmentsValues = (0, map_1.default)(attachmentsUi.attachmentsValues, (o) => {
                                    const aux = {};
                                    aux.name = o.name;
                                    aux.content = o.content;
                                    aux.type = o.type;
                            ...
                            if (attachmentsUi.hasOwnProperty('attachmentsBinary') &&
                                !(0, isEmpty_1.default)(attachmentsUi.attachmentsBinary) &&
                                items[i].binary) {
                                attachmentsBinary = (0, map_1.default)(attachmentsUi.attachmentsBinary, (o) => {
