...
class Salesforce {
    ...
    async execute() {
        ...
        n8n_workflow_2.LoggerProxy.debug(`Running "Salesforce" node named "${this.getNode.name}" resource "${resource}" operation "${operation}"`);
            ...
            try {
                if (resource === 'lead') {
                    ...
                    if (operation === 'update') {
                        ...
                        if (!Object.keys(updateFields).length) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'You must add at least one update field');
                        }
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Lead', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Lead', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'contact') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Contact', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Contact', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'customObject') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, customObject, returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, customObject, returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'document') {
                    if (operation === 'upload') {
                        ...
                        if (items[i].binary && items[i].binary[binaryPropertyName]) {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), `The property ${binaryPropertyName} does not exist`);
                        }
                ...
                if (resource === 'opportunity') {
                    if (operation === 'create' || operation === 'upsert') {
                        ...
                        if (additionalFields.ammount !== undefined) {
                            body.Amount = additionalFields.ammount;
                        }
                        if (additionalFields.owner !== undefined) {
                            body.OwnerId = additionalFields.owner;
                        }
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.ammount !== undefined) {
                            body.Amount = updateFields.ammount;
                        }
                        if (updateFields.owner !== undefined) {
                            body.OwnerId = updateFields.owner;
                        }
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Opportunity', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Opportunity', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'account') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Account', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Account', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'case') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Case', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Case', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'task') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Task', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Task', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'attachment') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'Attachment', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'Attachment', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'user') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = GenericFunctions_1.getQuery(options, 'User', returnAll);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = GenericFunctions_1.getQuery(options, 'User', returnAll, limit);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
