            ...
            try {
                if (resource === 'balance') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (!lodash_1.isEmpty(additionalFields)) {
                            Object.assign(body, helpers_1.adjustChargeFields(additionalFields));
                        }
                        ...
                        Object.assign(body, helpers_1.adjustChargeFields(updateFields));
                        const chargeId = this.getNodeParameter('chargeId', i);
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (!lodash_1.isEmpty(additionalFields)) {
                            Object.assign(body, helpers_1.adjustCustomerFields(additionalFields));
                        }
                        ...
                        Object.assign(body, helpers_1.adjustCustomerFields(updateFields));
                        const customerId = this.getNodeParameter('customerId', i);
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (!lodash_1.isEmpty(additionalFields)) {
                            Object.assign(body, helpers_1.adjustMetadata(additionalFields));
                        }
