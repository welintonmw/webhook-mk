        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    try {
                        await helpers_1.stripeApiRequest.call(this, 'GET', endpoint, {});
                    }
                    catch (error) {
                ...
                async create() {
                    ...
                    if (responseData.id === undefined || responseData.secret === undefined || responseData.status !== 'enabled') {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, { message: 'Stripe webhook creation response did not contain the expected data.' });
                    }
                    const webhookData = this.getWorkflowStaticData('node');
                    webhookData.webhookId = responseData.id;
                    webhookData.webhookEvents = responseData.enabled_events;
                ...
                async delete() {
                    ...
                    if (webhookData.webhookId !== undefined) {
                        ...
                        const body = {};
                        try {
                            await helpers_1.stripeApiRequest.call(this, 'DELETE', endpoint, body);
                        }
                        catch (error) {
                            return false;
                        }
...
exports.StripeTrigger = StripeTrigger;
//# sourceMappingURL=StripeTrigger.node.js.map