        ...
        for (let i = 0; i < items.length; i++) {
            if (resource === 'contact' || resource === 'company') {
                ...
                if (operation === 'get') {
                    ...
                    if (filterType === 'manual') {
                        ...
                        if (conditions.length !== 0) {
                            rules = GenericFunctions_1.getFilterRules(conditions, matchType);
                        ...
                        if (GenericFunctions_1.validateJSON(filterJsonRules) !== undefined) {
                    ...
                    if (simple) {
                        responseData = GenericFunctions_1.simplifyResponse(responseData);
                    }
                }
                ...
                if (operation === 'get') {
                    ...
                    if (returnAll) {
                        const limit = 100;
                        responseData = await GenericFunctions_1.agileCrmApiRequestAllItems.call(this, 'GET', endpoint, undefined, { page_size: limit });
                    }
                    else {
                        const limit = this.getNodeParameter('limit', 0);
                        responseData = await GenericFunctions_1.agileCrmApiRequest.call(this, 'GET', endpoint, undefined, { page_size: limit });
                    }
                }
                else if (operation === 'create') {
                    const jsonParameters = this.getNodeParameter('jsonParameters', i);
