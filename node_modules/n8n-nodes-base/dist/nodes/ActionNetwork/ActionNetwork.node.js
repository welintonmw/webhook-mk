            ...
            try {
                if (resource === 'attendance') {
                    if (operation === 'create') {
                        ...
                        const body = GenericFunctions_1.makeOsdiLink(personId);
                    ...
                    if (operation === 'create') {
                        ...
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustEventPayload(additionalFields));
                        }
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body.person, GenericFunctions_1.adjustPersonPayload(additionalFields));
                        }
                        ...
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPersonPayload(updateFields));
                        }
                        else {
                    ...
                    if (operation === 'create') {
                        ...
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        if (Object.keys(additionalFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPetitionPayload(additionalFields));
                        }
                        ...
                        const updateFields = this.getNodeParameter('updateFields', i);
                        if (Object.keys(updateFields).length) {
                            Object.assign(body, GenericFunctions_1.adjustPetitionPayload(updateFields));
                        }
                        else {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Please enter at least one field to update for the ${resource}.`);
                        }
                ...
                if (simplify) {
                    response = operation === 'getAll'
                        ? response.map((i) => GenericFunctions_1.simplifyResponse(i, resource))
                        : GenericFunctions_1.simplifyResponse(response, resource);
                }
