...
async function execute(items) {
    ...
    if (aggregate === 'aggregateIndividualFields') {
        ...
        const fieldsToInclude = (0, utils_1.prepareFieldsArray)(this.getNodeParameter('fieldsToInclude', 0, ''), 'Fields To Include');
    ...
    if (includeBinaries) {
        ...
        (0, utils_1.addBinariesToItem)(returnData, aggregatedItems, keepOnlyUnique);
    }
    return [returnData];
}
exports.execute = execute;
//# sourceMappingURL=concatenateItems.operation.js.map