            ...
            try {
                if (resource === 'firedAlert') {
                    ...
                    if (operation === 'delete') {
                        ...
                        GenericFunctions_1.populate(options, qs);
                        GenericFunctions_1.setCount.call(this, qs);
                        const endpoint = '/services/saved/searches';
                        responseData = await GenericFunctions_1.splunkApiRequest.call(this, 'GET', endpoint, {}, qs).then(GenericFunctions_1.formatFeed);
                    }
                }
                    ...
                    if (operation === 'create') {
                        ...
                        GenericFunctions_1.populate(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, earliest_time && { earliest_time: GenericFunctions_1.toUnixEpoch(earliest_time) }), latest_time && { latest_time: GenericFunctions_1.toUnixEpoch(latest_time) }), index_earliest && { index_earliest: GenericFunctions_1.toUnixEpoch(index_earliest) }), index_latest && { index_latest: GenericFunctions_1.toUnixEpoch(index_latest) }), rest), body);
                        ...
                        responseData = GenericFunctions_1.formatFeed(responseData);
                    }
                }
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await GenericFunctions_1.splunkApiRequest.call(this, 'GET', endpoint, {}, qs).then(GenericFunctions_1.formatResults);
                    }
                }
                    ...
                    if (operation === 'create') {
                        ...
                        GenericFunctions_1.populate(additionalFields, body);
                        ...
                        GenericFunctions_1.populate(Object.assign(Object.assign({}, roles && { roles }), rest), body);
                        const partialEndpoint = '/services/authentication/users/';
                        const userId = GenericFunctions_1.getId.call(this, i, 'userId', partialEndpoint);
                        const endpoint = `${partialEndpoint}/${userId}`;
                        responseData = await GenericFunctions_1.splunkApiRequest.call(this, 'POST', endpoint, body).then(GenericFunctions_1.formatFeed);
                    }
                }
            }
            catch (error) {
