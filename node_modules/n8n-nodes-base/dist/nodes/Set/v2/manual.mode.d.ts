...
export declare function execute(this: IExecuteFunctions, item: INodeExecutionData, i: number, options: SetNodeOptions, rawFieldsData: IDataObject, node: INode): Promise<INodeExecutionData | {
    json: {
        error: string;
        pairedItem: {
            item: number;
