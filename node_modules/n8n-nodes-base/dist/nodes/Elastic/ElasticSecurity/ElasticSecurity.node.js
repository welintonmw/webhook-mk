        ...
        this.methods = {
            ...
            credentialTest: {
                async elasticSecurityApiTest(credential) {
                    ...
                    const baseUrl = GenericFunctions_1.tolerateTrailingSlash(rawBaseUrl);
            ...
            try {
                if (resource === 'case') {
                    if (operation === 'create') {
                        ...
                        const _c = this.getNodeParameter('additionalFields', i), { syncAlerts } = _c, rest = __rest(_c, ["syncAlerts"]);
                        ...
                        Object.assign(body, {
                            cases: [
                                Object.assign(Object.assign({ id: caseId, version: await GenericFunctions_1.getVersion.call(this, `/cases/${caseId}`) }, (syncAlerts && { settings: { syncAlerts } })), rest),
                            ],
                        });
