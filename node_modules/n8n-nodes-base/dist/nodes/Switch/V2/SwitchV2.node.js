        ...
        this.methods = {
            loadOptions: {
                async getFallbackOutputOptions() {
                    var _a;
                    const rules = (_a = this.getCurrentNodeParameter('rules.rules')) !== null && _a !== void 0 ? _a : [];
                    const options = rules.map((rule, index) => ({
                        name: `${index} ${rule.outputKey}`,
                        value: index,
                    }));
                    options.unshift({
                        name: 'None',
        ...
        this.description = {
            ...
            properties: [
                ...
                },
                {
                    ...
                    default: -1,
                    description: 'The output to which to route all items which do not match any of the rules. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
                },
            ],
        };
    }
    async execute() {
        ...
        itemLoop: for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                const rules = this.getNodeParameter('rules.rules', itemIndex, []);
                mode = this.getNodeParameter('mode', itemIndex);
                item.pairedItem = { item: itemIndex };
                if (mode === 'expression') {
                    const outputsAmount = this.getNodeParameter('outputsAmount', itemIndex);
                    if (itemIndex === 0) {
...
//# sourceMappingURL=SwitchV2.node.js.map