...
class Pushover {
    constructor() {
        ...
        this.methods = {
            loadOptions: {
                async getSounds() {
                    const { sounds } = await GenericFunctions_1.pushoverApiRequest.call(this, 'GET', '/sounds.json', {});
                    const returnData = [];
                ...
                if (resource === 'message') {
                    if (operation === 'push') {
                        ...
                        if (body.attachmentsUi) {
                            const attachment = body.attachmentsUi
                                .attachmentsValues;
                            if (attachment) {
                        ...
                        responseData = await GenericFunctions_1.pushoverApiRequest.call(this, 'POST', '/messages.json', body);
