                    ...
                    try {
                        ...
                        if (credentials.ssl === true) {
                            ...
                            optsData.ca =
                                credentials.ca === ''
                                    ? undefined
                                    : [Buffer.from((0, utilities_1.formatPrivateKey)(credentials.ca))];
                            if (credentials.passwordless === true) {
                                optsData.cert =
                                    credentials.cert === ''
                                        ? undefined
                                        : Buffer.from((0, utilities_1.formatPrivateKey)(credentials.cert));
                                optsData.key =
                                    credentials.key === ''
                                        ? undefined
                                        : Buffer.from((0, utilities_1.formatPrivateKey)(credentials.key));
                                optsData.passphrase =
