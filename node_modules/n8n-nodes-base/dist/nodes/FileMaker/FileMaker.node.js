        ...
        this.methods = {
            loadOptions: {
                async getLayouts() {
                    let returnData;
                    try {
                        returnData = await GenericFunctions_1.layoutsApiRequest.call(this);
                    }
                    catch (error) {
                ...
                async getResponseLayouts() {
                    ...
                    let layouts;
                    try {
                        layouts = await GenericFunctions_1.layoutsApiRequest.call(this);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `FileMaker Error: ${error}`);
                    }
                ...
                async getFields() {
                    ...
                    let fields;
                    try {
                        fields = await GenericFunctions_1.getFields.call(this);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `FileMaker Error: ${error}`);
                    }
                ...
                async getScripts() {
                    ...
                    let scripts;
                    try {
                        scripts = await GenericFunctions_1.getScripts.call(this);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `FileMaker Error: ${error}`);
                    }
                ...
                async getPortals() {
                    ...
                    let portals;
                    try {
                        portals = await GenericFunctions_1.getPortals.call(this);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `FileMaker Error: ${error}`);
                    }
