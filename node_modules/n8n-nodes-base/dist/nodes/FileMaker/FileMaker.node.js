...
class FileMaker {
    constructor() {
        ...
        this.methods = {
            loadOptions: {
                async getLayouts() {
                    return await GenericFunctions_1.layoutsApiRequest.call(this);
                },
                async getResponseLayouts() {
                    ...
                    const layouts = await GenericFunctions_1.layoutsApiRequest.call(this);
                ...
                async getFields() {
                    const returnData = [];
                    const fields = await GenericFunctions_1.getFields.call(this);
                ...
                async getScripts() {
                    const returnData = [];
                    const scripts = await GenericFunctions_1.getScripts.call(this);
                ...
                async getPortals() {
                    const returnData = [];
                    const portals = await GenericFunctions_1.getPortals.call(this);
    ...
    async execute() {
        ...
        let token;
        try {
            token = await GenericFunctions_1.getToken.call(this);
        }
        catch (error) {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                if (action === 'record') {
                    ...
                    requestOptions.qs = {
                        portal: JSON.stringify(GenericFunctions_1.parsePortals.call(this, i)),
                        ...GenericFunctions_1.parseScripts.call(this, i),
                    };
                }
                    ...
                    requestOptions.body = {
                        query: GenericFunctions_1.parseQuery.call(this, i),
                    ...
                    requestOptions.body = {
                        fieldData: { ...GenericFunctions_1.parseFields.call(this, i) },
                        portalData: {},
                        ...GenericFunctions_1.parseScripts.call(this, i),
                    };
                }
                    ...
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), `The action "${action}" is not implemented yet!`, { itemIndex: i });
                }
                let response;
                try {
                ...
                if (typeof response === 'string') {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'DataAPI response body is not valid JSON. Is the DataAPI enabled?', { itemIndex: i });
                }
        ...
        await GenericFunctions_1.logout.call(this, token);
        return [returnData];
    }
}
