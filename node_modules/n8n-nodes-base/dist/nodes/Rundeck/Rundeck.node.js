        ...
        for (let i = 0; i < length; i++) {
            if (resource === 'job') {
                if (operation === 'execute') {
                    ...
                    const rundeckArguments = this.getNodeParameter('arguments', i)
                        .arguments;
