            ...
            try {
                ...
                if (resource === 'monitor') {
                    ...
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.uptimeRobotApiRequest.call(this, 'POST', '/getMonitors', { monitors });
                ...
                if (resource === 'alertContact') {
                    ...
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.uptimeRobotApiRequest.call(this, 'POST', '/getAlertContacts', { alert_contacts: id });
                ...
                if (resource === 'maintenanceWindow') {
                    ...
                    if (operation === 'get') {
                        ...
                        responseData = await GenericFunctions_1.uptimeRobotApiRequest.call(this, 'POST', '/getMWindows', { mwindows });
