            ...
            try {
                ...
                if (resource === 'astronomyPictureOfTheDay') {
                    if (operation === 'get') {
                        ...
                        qs.date =
                            (0, moment_timezone_1.default)(additionalFields.date).format('YYYY-MM-DD') ||
                ...
                if (resource === 'asteroidNeoFeed') {
                    if (operation === 'get') {
                        ...
                        qs.start_date =
                            (0, moment_timezone_1.default)(additionalFields.startDate).format('YYYY-MM-DD') || currentDate;
                        qs.end_date =
                            (0, moment_timezone_1.default)(additionalFields.endDate).format('YYYY-MM-DD') || currentDate;
                    }
                }
                if (resource === 'asteroidNeoLookup') {
                    if (operation === 'get') {
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `The operation '${operation}' is unknown!`, { itemIndex: i });
                    }
                }
                ...
                if (resource.startsWith('donki')) {
                    if (additionalFields.startDate) {
                        qs.startDate = (0, moment_timezone_1.default)(additionalFields.startDate).format('YYYY-MM-DD');
                    }
                    else {
                        qs.startDate = (0, moment_timezone_1.default)().subtract(30, 'days').format('YYYY-MM-DD');
                    }
                    if (additionalFields.endDate) {
                        qs.endDate = (0, moment_timezone_1.default)(additionalFields.endDate).format('YYYY-MM-DD');
                    }
                    else {
                        qs.endDate = (0, moment_timezone_1.default)().format('YYYY-MM-DD');
                    }
                    if (resource === 'donkiCoronalMassEjection') {
                        ...
                        if (operation === 'get') {
                            endpoint = '/DONKI/IPS';
                            qs.location = additionalFields.location || 'ALL';
                            qs.catalog = additionalFields.catalog || 'ALL';
                        }
                    }
                        ...
                        if (operation === 'get') {
                            ...
                            qs.type = additionalFields.type || 'all';
                        }
                    }
                }
                if (resource === 'earthImagery') {
                    if (operation === 'get') {
                        ...
                        qs.dim = additionalFields.dim || 0.025;
                        if (additionalFields.date) {
                            qs.date = (0, moment_timezone_1.default)(additionalFields.date).format('YYYY-MM-DD');
                        }
                        else {
                            qs.date = (0, moment_timezone_1.default)().format('YYYY-MM-DD');
                        }
                    }
                }
                ...
                if (returnAll) {
                    ...
                    responseData = await GenericFunctions_1.nasaApiRequest.call(this, 'GET', endpoint, qs);
                    if (propertyName !== '') {
                ...
                if (resource === 'earthImagery') {
                    ...
                    const data = await GenericFunctions_1.nasaApiRequest.call(this, 'GET', endpoint, qs, { encoding: null });
                    const newItem = {
                        json: items[i].json,
                        binary: {},
                    };
                ...
                if (resource === 'astronomyPictureOfTheDay') {
                    ...
                    if (download) {
                        const binaryProperty = this.getNodeParameter('binaryPropertyName', i);
                        const data = await GenericFunctions_1.nasaApiRequest.call(this, 'GET', endpoint, qs, { encoding: null }, responseData.hdurl);
...
exports.Nasa = Nasa;
//# sourceMappingURL=Nasa.node.js.map