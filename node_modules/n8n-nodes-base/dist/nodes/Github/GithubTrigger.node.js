                ...
                async create() {
                    ...
                    try {
                        ...
                        if (error.httpCode === '422') {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'A webhook with the identical URL probably exists already. Please delete it manually on Github!');
                        }
                        throw error;
                    }
                    if (responseData.id === undefined || responseData.active !== true) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), responseData, { message: 'Github webhook creation response did not contain the expected data.' });
                    }
