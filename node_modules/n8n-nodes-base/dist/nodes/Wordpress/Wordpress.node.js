            ...
            try {
                ...
                if (resource === 'page') {
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_1.wordpressApiRequest.call(this, 'POST', '/pages', body);
                    }
                    if (operation === 'update') {
                        ...
                        responseData = await GenericFunctions_1.wordpressApiRequest.call(this, 'POST', `/pages/${pageId}`, body);
                    }
                    if (operation === 'get') {
                        const pageId = this.getNodeParameter('pageId', i);
                        const options = this.getNodeParameter('options', i);
                        ...
                        responseData = await GenericFunctions_1.wordpressApiRequest.call(this, 'GET', `/pages/${pageId}`, {}, qs);
                    }
                    if (operation === 'getAll') {
                        const returnAll = this.getNodeParameter('returnAll', i);
                        const options = this.getNodeParameter('options', i);
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.wordpressApiRequestAllItems.call(this, 'GET', '/pages', {}, qs);
                        }
                        else {
                            qs.per_page = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.wordpressApiRequest.call(this, 'GET', '/pages', {}, qs);
                        }
                    }
                    if (operation === 'delete') {
                        const pageId = this.getNodeParameter('pageId', i);
                        ...
                        responseData = await GenericFunctions_1.wordpressApiRequest.call(this, 'DELETE', `/pages/${pageId}`, {}, qs);
                    }
                }
                if (resource === 'user') {
                    if (operation === 'create') {
