            ...
            try {
                ...
                if (mode === 'xmlToJson') {
                    ...
                    if (item.json[dataPropertyName] === undefined) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Item has no JSON property called "${dataPropertyName}"`, { itemIndex });
                    }
                    const json = await parser.parseStringPromise(item.json[dataPropertyName]);
                    returnData.push({ json: (0, n8n_workflow_1.deepCopy)(json) });
                }
